...
$htmlFormStartOut .= '<form name="frmViewLotto" id="frmViewLotto" method="get" action="view_lottario_winnings.php">'
...
. '<tr><td>Draw Date</td><td colspan="2">Match 6</td><td colspan="2">Match 5 + Bonus</td>'
. '<td colspan="2">Match 5</td><td colspan="2">Match 4</td><td colspan="2">Match 3</td>'
. '<td colspan="2">Match Early Bird</td></tr>';
 ...
 * 
 */
$db_res = $OLGLottery->OLGLottarioWinningsGetDraw($st_date, $ed_date, $st_row_num, $ed_row_num);
//print_r($db_res);
if (is_array($db_res)) {
  foreach ($db_res as $db_row) {


$htmlMainCont .= '<tr class="Early Bird Row">'
		. '<td>' . date('Y-m-d',strtotime($db_row["drawdate"])) . '</td>'
		. '<td nowrap>' . $db_row["snum1"] . "-" . $db_row["snum2"]  . "-" .  $db_row["snum3"]  . "-" .  $db_row["snum4"]; 
$htmlMainCont .=  "-" . $db_row["snum5"] . "-" . $db_row["snum6"]  . " Bonus: " . $db_row["snumbonus"];
$htmlMainCont .=  "<br />EB: " . $db_row["eb_snum1"] . "-" . $db_row["eb_snum2"] . "-" . $db_row["eb_snum3"] . "-" . $db_row["eb_snum4"]; 
$htmlMainCont .= '</td>'
 . '<td>' . $db_row["m_6_count"] . '</td>'
 . '<td><span class="win_amt">' . money_format('%(#12n', $db_row["m_6_prze_amt"]) . '</td>'
 . '<td>' . $db_row["m_5_b_count"] . '</td>'
 . '<td><span class="win_amt">' . money_format('%(#12n', $db_row["m_5_b_prze_amt"]) . '</td>'
 . '<td>' . $db_row["m_5_count"] . '</td>'
 . '<td><span class="win_amt">' . money_format('%(#12n', $db_row["m_5_prze_amt"]) . '</td>'
 . '<td>' . $db_row["m_4_count"] . '</td>'
 . '<td><span class="win_amt">' . money_format('%(#12n', $db_row["m_4_prze_amt"]) . '</td>'
 . '<td>' . $db_row["m_3_count"] . '</td>'
 . '<td><span class="win_amt">' . money_format('%(#12n', $db_row["m_3_prze_amt"]) . '</td>'
 . '<td>' . $db_row["m_e_bird_count"] . '</td>'
 . '<td><span class="win_amt">' . money_format('%(#12n', $db_row["m_e_bird_prze_amt"]) . '</td>'
 . '</tr>';
