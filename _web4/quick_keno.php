...
$htmlMainCont .= '<tr><td align="center"><h3>Keno Quick Pick - 10 : ' . implode("-",$QuickPick->OLGKenoQuickPick(10)) . '</h3></td></tr>';
$htmlMainCont .= '<tr><td align="center"><h3>Keno Quick Pick - 9 : ' . implode("-",$QuickPick->OLGKenoQuickPick(9)) . '</h3></td></tr>';
$htmlMainCont .= '<tr><td align="center"><h3>Keno Quick Pick - 8 : ' . implode("-",$QuickPick->OLGKenoQuickPick(8)) . '</h3></td></tr>';
$htmlMainCont .= '<tr><td align="center"><h3>Keno Quick Pick - 7 : ' .  implode("-",$QuickPick->OLGKenoQuickPick(7)) . '</h3></td></tr>';
$htmlMainCont .= '<tr><td align="center"><h3>Keno Quick Pick - 6 : ' . implode("-",$QuickPick->OLGKenoQuickPick(6)) . '</h3></td></tr>';
$htmlMainCont .= '<tr><td align="center"><h3>Keno Quick Pick - 5 : ' .  implode("-",$QuickPick->OLGKenoQuickPick(5)) . '</h3></td></tr>';
$htmlMainCont .= '<tr><td align="center"><h3>Keno Quick Pick - 4 : ' . implode("-",$QuickPick->OLGKenoQuickPick(4)) . '</h3></td></tr>';
$htmlMainCont .= '<tr><td align="center"><h3>Keno Quick Pick - 3 : ' . implode("-",$QuickPick->OLGKenoQuickPick(3)) . '</h3></td></tr>';
