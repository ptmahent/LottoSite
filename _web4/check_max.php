...
if (!is_array($lotto_validat_res)) {
  ...
  foreach ($lotto_validat_res as $lotto_single_game) {
      ...
      foreach ($lotto_single_game["validation_res"] as $s_single_match) {
       ...
       $htmlOut .= "<tr><td>" . date('Y-m-d',strtotime($s_single_match["drawdate"])) . "</td>"
          ...
          if ($b_win_num_match) {
            ...
            $htmlOut .= "<span class='matchBonusNumber'>" . $lotto_single_game["played_nums"][0] . "</span>";
          ...
          if ($b_win_num_match) {
            ...
            $htmlOut .= "<span class='matchBonusNumber'>" . $lotto_single_game["played_nums"][1] . "</span>";
         ...
         $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            ...
            $htmlOut .= "<span class='matchBonusNumber'>" . $lotto_single_game["played_nums"][2] . "</span>";
         ...
         $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            ...
            $htmlOut .= "<span class='matchBonusNumber'>" . $lotto_single_game["played_nums"][3] . "</span>";
        ...
        $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            ...
            $htmlOut .= "<span class='matchBonusNumber'>" . $lotto_single_game["played_nums"][4] . "</span>";
          ...
          if ($b_win_num_match) {
            ...
            $htmlOut .= "<span class='matchBonusNumber'>" . $lotto_single_game["played_nums"][5] . "</span>";
        ...
        $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            ...
            $htmlOut .= "<span class='matchBonusNumber'>" . $lotto_single_game["played_nums"][6] . "</span>";
    ...
    $htmlOut .= "</td><td>Draw Numbers: " . $s_single_match["draw_numbers"][0] . " - " . $s_single_match["draw_numbers"][1] . " - " . $s_single_match["draw_numbers"][2] . " - " . $s_single_match["draw_numbers"][3] . " - " . $s_single_match["draw_numbers"][4] . " - " . $s_single_match["draw_numbers"][5] . " - " . $s_single_match["draw_numbers"][6] . " - B: " . $s_single_match["draw_bonus"] . "</td></tr>";
      } 
    }
    $icur_game_cnt++;
  }
