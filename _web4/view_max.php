...
$htmlFormStartOut .= '<form name="frmViewLotto" id="frmViewLotto" method="get" action="view_max.php">'
...
$htmlMainCont .= '<div id="game_draw_body"><table border="0" colspan="0" width="100%">'
			  . '<tr><td>Draw Date</td><td>Seq Num</td><td colspan="7">Winning Number</td>'
 ...
 * 
 */
$db_res = $naLottery->naMaxGetDraw($st_date, $ed_date, $st_row_num, $ed_row_num);
//print_r($db_res);
if (is_array($db_res)) {
  $total_rs_count = count($db_res);
  foreach ($db_res as $db_row) {

$htmlMainCont .= '<tr class="MaxRow">'
