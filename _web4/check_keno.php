  ...
  foreach ($lotto_validat_res as $lotto_single_game) {
      ...
      if ($s_single_match["category"] >= 7) {
       ...
       if ($s_single_match["category"] >= 8) {
         ...
         if ($b_win_num_match) {
              $htmlOut .=  "<span class='matchNumber'>" . $lotto_single_game["played_nums"][7] . "</span>";
            }
         else {
              $htmlOut .=  "<span class='notMatchNumber'>" . $lotto_single_game["played_nums"][7] . "</span>";
            }
       } else {
         $htmlOut .=  "&nbsp;";
       }
       ...
       if ($s_single_match["category"] >= 9) {
         ...
         if ($b_win_num_match) {
              $htmlOut .=  "<span class='matchNumber'>" . $lotto_single_game["played_nums"][8] . "</span>";
            }
         else {
              $htmlOut .=  "<span class='notMatchNumber'>" . $lotto_single_game["played_nums"][8] . "</span>";
            }
       } else {
        $htmlOut .= "&nbsp;";
       }
       ...
       if ($s_single_match["category"] >= 10) {
         ...
         if ($b_win_num_match) {
              $htmlOut .=  "<span class='matchNumber'>" . $lotto_single_game["played_nums"][9] . "</span>";
            }
         else {
              $htmlOut .=  "<span class='notMatchNumber'>" . $lotto_single_game["played_nums"][9] . "</span>";
            }
       } else {
         $htmlOut .=  "&nbsp;";
       }
       $htmlOut .= "</td><td>" .
		     " Draw Numbers: " .  $s_single_match["draw_numbers"][0] . " - " . $s_single_match["draw_numbers"][1] . " - " . $s_single_match["draw_numbers"][2] . " - " . $s_single_match["draw_numbers"][3] . " - " . $s_single_match["draw_numbers"][4] . " - " . $s_single_match["draw_numbers"][5] . " - " . $s_single_match["draw_numbers"][6] . " - " . $s_single_match["draw_numbers"][7] . " - " . $s_single_match["draw_numbers"][8] . " - " . $s_single_match["draw_numbers"][9];
       $htmlOut .= "</td></tr>";
      } 
    }
    $icur_game_cnt++;
