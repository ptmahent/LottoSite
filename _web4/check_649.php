...
//    	print_r($lotto_single_game);
    ...
    $htmlOut .= "
    <tr>
    <td>" . date('Y-m-d',strtotime($s_single_match["drawdate"])) . "</td>"; 
    $htmlOut .= "<td>";
    ...
    $htmlOut .= "</td>
    <td>Draw Numbers: " . $s_single_match["draw_numbers"][0] . " - " . $s_single_match["draw_numbers"][1] . " - " . $s_single_match["draw_numbers"][2] . " - " . $s_single_match["draw_numbers"][3] . " - " . $s_single_match["draw_numbers"][4] . " - " . $s_single_match["draw_numbers"][5] . " - B: " . $s_single_match["draw_bonus"]; 
	$htmlOut .= "</td></tr>";
