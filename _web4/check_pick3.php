  ...
  foreach ($lotto_validat_res as $lotto_single_game) {
     ...
     //print_r($s_single_match);
      ...
      if ($s_single_match["win_prze_straight_amount"] > 0) {
        $htmlOut .=  "Straight Win - <span class='win_amt'>$" . money_format('%(#12n',$s_single_match["win_prze_straight_amount"]) . "</span><br />";
      }
      $htmlOut .= "</td><td>";

      if ($s_single_match["win_prze_box_amount"] > 0) {
        $htmlOut .=  "Box Win - <span class='win_amt'>$" . money_format('%(#12n',$s_single_match["win_prze_box_amount"]) . "</span><br />";
      }
...
$htmlOut .= "<tr><td >" .  $strOutput . "</td><td>&nbsp;</td></tr></table>";
