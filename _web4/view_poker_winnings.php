...
$htmlFormStartOut .= '<form name="frmViewLotto" id="frmViewLotto" method="get" action="view_poker_winnings.php">'
...
if (is_array($db_res)) {
  ...
  $htmlMainCont .= '<tr class="649Row">'
				. '<td rowspan="2">' . date('Y-m-d',strtotime($db_row["drawdate"])) . '</td>'
				. '<td rowspan="2">' . $db_row["scard1"] . "-" . $db_row["scard2"] . "-" . $db_row["scard3"] . "-" . $db_row["scard4"] . "-" . $db_row["scard5"] . '</td>'
				. '<td>' . $db_row["m_rf_i_count"] . '</td>'
				. '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_rf_i_prze_amt"]) . '</span></td>'
				. '<td>' . $db_row["m_sf_i_count"] . '</td>'
				. '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_sf_i_prze_amt"]) . '</span></td>'
				. '<td>' . $db_row["m_4k_i_count"] . '</td>'
				. '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_4k_i_prze_amt"]) . '</span></td>'
				. '<td>' . $db_row["m_fh_i_count"] . '</td>'
				. '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_fh_i_prze_amt"]) . '</span></td>'
				. '<td>' . $db_row["m_f_i_count"] . '</td>'
				. '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_f_i_prze_amt"]) . '</span></td>'
				. '<td>' . $db_row["m_s_i_count"] . '</td>'
				. '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_s_i_prze_amt"]) . '</span></td>'
				. '<td>' . $db_row["m_3k_i_count"] . '</td>'
				. '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_3k_i_prze_amt"]) . '</span></td>'
				. '<td>' . $db_row["m_2p_i_count"] . '</td>'
				. '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_2p_i_prze_amt"]) . '</span></td>'
				. '<td>' . $db_row["m_pj_i_count"] . '</td>'
				. '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_pj_i_prze_amt"]) . '</span></td>';

	$htmlMainCont .= '</tr>'
				. '<tr>'
				. '<td>' . $db_row["m_5_d_count"] . '</td>'
				. '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_5_d_prze_amt"]) . '</span></td>'
				. '<td>' . $db_row["m_4_d_count"] . '</td>'
				. '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_4_d_prze_amt"]) . '</span></td>'
				. '<td>' . $db_row["m_3_d_count"] . '</td>'
				. '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_3_d_prze_amt"]) . '</span></td>'
				. '<td >' . $db_row["m_2_d_count"] . '</td>'
				. '<td colspan="11"><span class="win_amt">' . money_format('%(#12n',$db_row["m_2_d_prze_amt"]) . '</span></td>'
				. '</tr>';
