...
if (!is_array($lotto_validat_res)) {
  ...
  foreach ($lotto_validat_res as $lotto_single_game) {
    ...
    $htmlOut .= "<tr><td>" . date('Y-m-d',strtotime($s_single_match["drawdate"])) . "</td>"
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<span class='matchNumber'>" . $lotto_single_game["played_nums"][0][0] . "</span>";
          } elseif ($b_bonus_num_match) {
            $htmlOut .= "<span class='matchBonusNumber'>" . $lotto_single_game["played_nums"][0][0] . "</span>";
             
          } else {
            $htmlOut .= "<span class='notMatchNumber'>" . $lotto_single_game["played_nums"][0][0] . "</span>";
          }
         $htmlOut .= "</td><td>";
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<span class='matchNumber'>" . $lotto_single_game["played_nums"][0][1] . "</span>";
          } elseif ($b_bonus_num_match) {
            $htmlOut .= "<span class='matchBonusNumber'>" . $lotto_single_game["played_nums"][0][1] . "</span>";
             
          } else {
            $htmlOut .= "<span class='notMatchNumber'>" . $lotto_single_game["played_nums"][0][1] . "</span>";
          }
          $htmlOut .= "</td><td>";
        ...
        $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<span class='matchNumber'>" . $lotto_single_game["played_nums"][0][2] . "</span>";
          } elseif ($b_bonus_num_match) {
            $htmlOut .= "<span class='matchBonusNumber'>" . $lotto_single_game["played_nums"][0][2] . "</span>";
             
          } else {
            $htmlOut .= "<span class='notMatchNumber'>" . $lotto_single_game["played_nums"][0][2] . "</span>";
          }
         $htmlOut .= "</td><td>";
        ...
        $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<span class='matchNumber'>" . $lotto_single_game["played_nums"][0][3] . "</span>";
          } elseif ($b_bonus_num_match) {
            $htmlOut .= "<span class='matchBonusNumber'>" . $lotto_single_game["played_nums"][0][3] . "</span>";
             
          } else {
            $htmlOut .= "<span class='notMatchNumber'>" . $lotto_single_game["played_nums"][0][3] . "</span>";
          }    
          $htmlOut .= "</td><td>";
        ...
        $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<span class='matchNumber'>" . $lotto_single_game["played_nums"][0][4] . "</span>";
          } elseif ($b_bonus_num_match) {
            $htmlOut .= "<span class='matchBonusNumber'>" . $lotto_single_game["played_nums"][0][4] . "</span>";
             
          } else {
            $htmlOut .= "<span class='notMatchNumber'>" . $lotto_single_game["played_nums"][0][4] . "</span>";
          }    
          $htmlOut .= "</td><td>";
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<span class='matchNumber'>" . $lotto_single_game["played_nums"][0][5] . "</span>";
          } elseif ($b_bonus_num_match) {
            $htmlOut .= "<span class='matchBonusNumber'>" . $lotto_single_game["played_nums"][0][5] . "</span>";
             
          } else {
            $htmlOut .= "<span class='notMatchNumber'>" . $lotto_single_game["played_nums"][0][5] . "</span>";
          }
         $htmlOut .= "</td>";
         if (is_array($s_single_match["played_nums"][1])) {
           $htmlOut .= "<td> EB:"; 
	        ...
	        $b_win_num_match = false;
          	...
          	if ($b_win_num_match) {
            	$htmlOut .= "<span class='matchNumber'>" . $lotto_single_game["played_nums"][1][0] . "</span>";
          	} else {
            	$htmlOut .= "<span class='notMatchNumber'>" . $lotto_single_game["played_nums"][1][0] . "</span>";
          	}
          $htmlOut .= "</td><td>";
         ...
         $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<span class='matchNumber'>" . $lotto_single_game["played_nums"][1][1] . "</span>";
          } else {
            $htmlOut .= "<span class='notMatchNumber'>" . $lotto_single_game["played_nums"][1][1] . "</span>";
          }
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<span class='matchNumber'>" . $lotto_single_game["played_nums"][1][2] . "</span>";
          } else {
            $htmlOut .= "<span class='notMatchNumber'>" . $lotto_single_game["played_nums"][1][2] . "</span>";
          }
          $htmlOut .= " </td><td> ";
         ...
         $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<span class='matchNumber'>" . $lotto_single_game["played_nums"][1][3] . "</span>";
          } else {
            $htmlOut .= "<span class='notMatchNumber'>" . $lotto_single_game["played_nums"][1][3] . "</span>";
          }
          $htmlOut .= "</td>";
    	...
    	$htmlOut .= "<td nowrap>"; 	
      	...
      	if ($s_single_match["win_prze_ebird_amount"] > 0) {
       		$htmlOut .= " - EB: <span class='win_amt'>$" . money_format('%(#12n',$s_single_match["win_prze_ebird_amount"]) . "</span><br />";
      	}
    
    $htmlOut .= "</td><td>Draw Numbers: " . 
    	$s_single_match["draw_numbers"][0] . " - " . $s_single_match["draw_numbers"][1] . " - " . $s_single_match["draw_numbers"][2] . " - " . $s_single_match["draw_numbers"][3] . " - " . $s_single_match["draw_numbers"][4] . " - " . $s_single_match["draw_numbers"][5] . " - B: " . $s_single_match["draw_bonus"]; 
	$htmlOut .= " Early Bird: " . $s_single_match["eb_draw_numbers"][0] . " - " . $s_single_match["eb_draw_numbers"][1] . " - " . $s_single_match["eb_draw_numbers"][2] . " - " . $s_single_match["eb_draw_numbers"][3];
	$htmlOut .= "</td>";
