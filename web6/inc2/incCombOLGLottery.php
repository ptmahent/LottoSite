...
{snum10: INT}
    ...
    function OLGCombKenoAdd($iCategory, $snum1, $snum2, $snum3 = "", $snum4 = "", $snum5 = "", $snum6 = "", $snum7 = "", $snum8 = "", $snum9 = "", $snum10 = "") {
         if (!$this->db_obj) {
            $this->db_obj = new db();
          }
        
        $ssql1 = sprintf("INSERT INTO `tbl_comb_keno` (`iCategory`, `snum1`");
        $ssql2 = sprintf(" VALUES (%u, %u", $iCategory, $snum1);
     ...
     function OLGCombKenoGetId ($iCategory, $snum1, $snum2, $snum3 = "", $snum4 = "", $snum5 = "", $snum6 = "", $snum7 = "", $snum8 = "", $snum9 = "", $snum10 = "") {
        if (!$this->db_obj) {
          $this->db_obj = new db();
        }
    	...
    	if ($iCategory >= 2) {
    		$ssql1 = sprintf(" iCategory = %u AND snum1 = %u AND snum2 = %u ", $iCategory, $snum1, $snum2);
    	}
    	if ($iCategory >= 3) {
