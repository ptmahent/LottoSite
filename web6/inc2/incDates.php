<?php
class gDates {
    static public function getNextWeek($from_date = "") {
    ...
    static public function getNextDay($from_date = "") {
      $first_dte = getdate(strtotime($from_date));
      $date_dte = Date('d-m-Y', mktime(0,0,0,$first_dte["mon"], $first_dte["mday"] + 1,  $first_dte["year"]));
      return $date_dte;
    }
    
    static public function getAllDays($from_date = "", $to_date) {
      $first_dte  = getdate(strtotime($from_date));
      $last_dte   = getdate(strtotime($last_date));
    ...
    static public function getNextWed($from_date = "") {
      $first_dte = getdate(strtotime($from_date));
    ...
    static public function getNextFri($from_date = "") {
      $first_dte = getdate(strtotime($from_date));
    ...
    static public function getNextSat($from_date = "") {
      $first_dte = getdate(strtotime($from_date));
    ...
    static public function getNextWedSat($from_date = "") {
      $first_dte = getdate(strtotime($from_date));
    ...
    static public function getAllWedSat($from_date, $to_date){
        print_r($from_date);
        print_r($to_date); 
        $first_dte = getdate(strtotime($from_date));
    ...
    static public function getAllSundays($from_date, $to_date){ 
        $first_dte = getdate(strtotime($from_date));
        $last_dte = getdate(strtotime($to_date));
    ...
    // will echo all saturdays found between date range. 
    static public function getAllThursday($from_date, $to_date){ 
        $first_dte = getdate(strtotime($from_date));
        $last_dte = getdate(strtotime($to_date));
    ...
    // will echo all saturdays found between date range. 
    static public function getAllTuesday($from_date, $to_date){ 
        $first_dte = getdate(strtotime($from_date));
        $last_dte = getdate(strtotime($to_date));
     ...
     // will echo all saturdays found between date range. 
    static public function getAllMondays($from_date, $to_date){ 
        $first_dte = getdate(strtotime($from_date));
        $last_dte = getdate(strtotime($to_date));
    ...
    // will echo all saturdays found between date range. 
    static public function getAllFridays($from_date, $to_date){ 
        $first_dte = getdate(strtotime($from_date));
        $last_dte = getdate(strtotime($to_date));
    ...
    // will echo all saturdays found between date range. 
    static public function getAllWednesdays($from_date, $to_date){ 
    ...
    // will echo all saturdays found between date range. 
    static public function getAllSaturdays($from_date, $to_date){ 
        // getting number of days between two date range.
    ...
    static public function count_days( $a, $b ) 
    { 
    ...
    static public function getMonthNum($monthName) {
      $monthNum = array (
                "january" => 1,
                "february" => 2,
                "march" => 3,
    ...
    static public function getShortMonthNum($monthName) {
      $monthNum = array (
                "jan" => 1,
                "feb" => 2,
                "mar" => 3,
