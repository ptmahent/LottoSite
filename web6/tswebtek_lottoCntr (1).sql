...
--
-- Host: localhost
-- Generation Time: Oct 26, 2011 at 03:26 PM
...
DROP TABLE IF EXISTS `tbl_alc_49`;
...
DROP TABLE IF EXISTS `tbl_alc_bucko`;
...
DROP TABLE IF EXISTS `tbl_alc_keno`;
...
DROP TABLE IF EXISTS `tbl_alc_pik4`;
...
DROP TABLE IF EXISTS `tbl_alc_tag`;
...
DROP TABLE IF EXISTS `tbl_archive_stats`;
...
DROP TABLE IF EXISTS `tbl_bclc_49`;
...
DROP TABLE IF EXISTS `tbl_bclc_49_winnings`;
...
DROP TABLE IF EXISTS `tbl_bclc_extra`;
...
DROP TABLE IF EXISTS `tbl_bclc_extra_winnings`;
...
DROP TABLE IF EXISTS `tbl_bclc_keno`;
...
DROP TABLE IF EXISTS `tbl_bclc_keno_winnings`;
...
DROP TABLE IF EXISTS `tbl_fetch_data_stats`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3273 ;
...
DROP TABLE IF EXISTS `tbl_fetch_detail`;
...
DROP TABLE IF EXISTS `tbl_lottery_games`;
...
--
-- Table structure for table `tbl_lottery_jackpots`
--

DROP TABLE IF EXISTS `tbl_lottery_jackpots`;
CREATE TABLE IF NOT EXISTS `tbl_lottery_jackpots` (
  `jackpot_id` int(11) NOT NULL AUTO_INCREMENT,
  `jackpot_drawdate` date NOT NULL,
  `current_drawdate` date NOT NULL,
  `jackpot_amount` double NOT NULL,
  `jackpot_bonus` double NOT NULL,
  `jackpot_desc` varchar(256) NOT NULL,
  `jackpot_maxmill` int(11) NOT NULL,
  `jackpot_gameid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `tbl_lot_win_locations`;
...
DROP TABLE IF EXISTS `tbl_on_lottario`;
...
DROP TABLE IF EXISTS `tbl_on_lottario_winnings`;
...
DROP TABLE IF EXISTS `tbl_on_major_winners`;
...
DROP TABLE IF EXISTS `tbl_on_payday`;
...
DROP TABLE IF EXISTS `tbl_on_pick3`;
...
DROP TABLE IF EXISTS `tbl_on_pick3_winnings`;
...
DROP TABLE IF EXISTS `tbl_on_pick4`;
...
DROP TABLE IF EXISTS `tbl_on_pick4_winnings`;
...
DROP TABLE IF EXISTS `tbl_on_poker`;
...
DROP TABLE IF EXISTS `tbl_on_poker_winnings`;
...
DROP TABLE IF EXISTS `tbl_on_winners_1000_more`;
...
DROP TABLE IF EXISTS `tbl_on_winning_group`;
...
DROP TABLE IF EXISTS `tbl_on_winning_locations`;
...
DROP TABLE IF EXISTS `tbl_qlc_49`;
...
DROP TABLE IF EXISTS `tbl_qlc_49_winnings`;
...
DROP TABLE IF EXISTS `tbl_qlc_astro`;
...
DROP TABLE IF EXISTS `tbl_qlc_banco`;
...
DROP TABLE IF EXISTS `tbl_qlc_extra`;
...
DROP TABLE IF EXISTS `tbl_qlc_jour_de_paye`;
...
DROP TABLE IF EXISTS `tbl_qlc_la_mini`;
...
DROP TABLE IF EXISTS `tbl_qlc_la_quotidienne_3`;
...
DROP TABLE IF EXISTS `tbl_qlc_la_quotidienne_4`;
...
DROP TABLE IF EXISTS `tbl_qlc_tango`;
...
DROP TABLE IF EXISTS `tbl_qlc_triplex`;
...
DROP TABLE IF EXISTS `tbl_select_match`;
...
--
-- Table structure for table `tbl_social_update`
--

DROP TABLE IF EXISTS `tbl_social_update`;
CREATE TABLE IF NOT EXISTS `tbl_social_update` (
  `gameid` int(11) NOT NULL,
  `post_lastupdate` date NOT NULL,
  `last_drawdate` date NOT NULL,
  `lotto_draw_id` int(11) NOT NULL
...
DROP TABLE IF EXISTS `tbl_wclc_49`;
...
DROP TABLE IF EXISTS `tbl_wclc_49_winnings`;
...
DROP TABLE IF EXISTS `tbl_wclc_extra`;
...
DROP TABLE IF EXISTS `tbl_wclc_keno`;
...
DROP TABLE IF EXISTS `tbl_wclc_payday`;
...
DROP TABLE IF EXISTS `tbl_wclc_pick3`;
...
DROP TABLE IF EXISTS `tbl_wclc_pick4`;
...
DROP TABLE IF EXISTS `tbl_web_urls`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4053 ;
...
DROP TABLE IF EXISTS `tbl_winning_prizes`;
