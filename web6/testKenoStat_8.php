							...
							for ($i_5 = 1; $i_5 < 21; $i_5++) {
								...
								for ($i_6 = 1; $i_6 < 21; $i_6++) {
									...
									if (!(
  										...
  										($i_2 == $i_3) || ($i_2 == $i_4) || ($i_3 == $i_4) ||
  										($i_1 == $i_5) || ($i_2 == $i_5) || ($i_3 == $i_5) ||
  										($i_4 == $i_5) || ($i_1 == $i_6) || ($i_2 == $i_6) ||
  										($i_3 == $i_6) || ($i_4 == $i_6) || ($i_5 == $i_6) 
										)){
									...
									for ($i_7 = 1; $i_7 < 21; $i_7++) {
										...
										for ($i_8 = 1; $i_8 < 21; $i_8++) {
											...
											if (!(
													...
													($i_4 == $i_5) || ($i_1 == $i_6) || ($i_2 == $i_6) ||
													($i_3 == $i_6) || ($i_4 == $i_6) || ($i_5 == $i_6) || 
													($i_1 == $i_7) || ($i_2 == $i_7) || ($i_3 == $i_7) ||
													($i_4 == $i_7) || ($i_5 == $i_7) || ($i_6 == $i_7) ||
													($i_1 == $i_8) || ($i_2 == $i_8) || ($i_3 == $i_8) ||
													($i_4 == $i_8) || ($i_5 == $i_8) || ($i_6 == $i_8) ||
													($i_7 == $i_8) 
