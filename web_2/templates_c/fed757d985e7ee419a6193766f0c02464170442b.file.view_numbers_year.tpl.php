<?php /* Smarty version Smarty-3.0.8, created on 2012-01-17 00:41:49
         compiled from "/home1/tswebtek/tswlotto/web_2/templates/view_numbers_year.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8876379074f150a1df38fb8-56995988%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fed757d985e7ee419a6193766f0c02464170442b' => 
    array (
      0 => '/home1/tswebtek/tswlotto/web_2/templates/view_numbers_year.tpl',
      1 => 1326777344,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8876379074f150a1df38fb8-56995988',
  'function' => 
  array (
  ),
...
<script type="text/javascript" src="../inc/lib/picnet.table.filter.min.js"></script>
	...
	<script src="inc/js/jquery-ui-1.8.16.custom.min.js"></script>
	<link rel="stylesheet" href="inc/css/flick/jquery-ui-1.8.16.custom.css" type="text/css" />

<script type="text/javascript" src="inc/picnet.table.filter.min.js"></script>
...
<?php echo $_smarty_tpl->getVariable('JSOUTPUT')->value;?>
		...
		var div_count = 0;
		var comb_win_cnt = 0;
		function Open_Comb_DiagWin(html) {
		
			var div_count = $('.dialog_window').length + 1;
			//var div_id = 'dialog_window_' + comb_win_cnt + '_' + div_count;
			var div_id = 'dialog_window_' + diag_cur_comb_date;
			var div_title = diag_title;
			comb_win_cnt++;
			var div_content = html;
			...
			if (diag_win_pos == 0) {
				pos_win = "left";
				diag_win_pos++;
			} else if (diag_win_pos == 1) {
				pos_win = "right";
				diag_win_pos++;
			} else if (diag_win_pos == 2) {
				pos_win = "top";
				diag_win_pos++;
			} else if (diag_win_pos == 3) {
				pos_win = "bottom";
				diag_win_pos = 0;
			} 
