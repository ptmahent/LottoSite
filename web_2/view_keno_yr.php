 ...
 * 
  ...
  //$sSelectedDate = mktime(0,0,0,date('m'),date('d'),date('Y'));
   ...
   $data_avail = $OLGLottery->OLGKenoGetFirstLastDataAvail();
	...
	$smarty->template_dir = '/home1/tswebtek/tswlotto/web9/templates/';
	$smarty->compile_dir  = '/home1/tswebtek/tswlotto/web9/templates_c/';
	$smarty->config_dir   = '/home1/tswebtek/tswlotto/web9/configs/';
	$smarty->cache_dir	  = '/home1/tswebtek/tswlotto/web9/cache/';
...
$htmlFormStartOut .= '<form name="frmViewLotto" id="frmViewLotto" method="get" action="view_keno_yr.php">'
...
$htmlThirdNav .= "<span class='not-selected' id='nav_disp_limit_M'>Month</span> | <span class='not-selected' id='nav_disp_limit_Y'>Year</span></div>";

 /* | <span class='not-selected' id='nav_disp_limit_100'>100 Draws</span> | <span class='not-selected' id='nav_disp_limit_200'>200 Draws</span>"
			  . "</div>";
