...
$htmlMainCont .= '<td id="winCount">' . $db_row['m_10_10_1_count'] . '<hr />'
			  ...
			  . '</td>'
			  . '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row['m_10_10_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_10_10_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_10_10_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_10_10_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>'
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_10_9_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_10_9_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_10_9_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_10_9_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>'
			  . '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row['m_10_8_1_prze_amt'])  . '<hr />' 
			  . money_format('%(#12n',$db_row['m_10_8_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_10_8_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_10_8_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>'
			  . '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row['m_10_7_1_prze_amt'])  . '<hr />' 
			  . money_format('%(#12n',$db_row['m_10_7_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_10_7_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_10_7_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>'
			  . '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row['m_10_0_1_prze_amt'])  . '<hr />' 
			  . money_format('%(#12n',$db_row['m_10_0_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_10_0_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_10_0_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>'
			  . '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row['m_9_9_1_prze_amt'])  . '<hr />' 
			  . money_format('%(#12n',$db_row['m_9_9_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_9_9_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_9_9_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>'
			  . '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row['m_9_8_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_9_8_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_9_8_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_9_8_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>' 
			  . '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row['m_9_7_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_9_7_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_9_7_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_9_7_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>' 
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_9_6_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_9_6_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_9_6_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_9_6_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>' 
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_8_8_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_8_8_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_8_8_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_8_8_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>' 
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_8_7_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_8_7_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_8_7_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_8_7_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>' 
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_8_6_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_8_6_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_8_6_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_8_6_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>' 
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_7_7_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_7_7_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_7_7_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_7_7_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>' 
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_7_6_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_7_6_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_7_6_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_7_6_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>' 
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_7_5_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_7_5_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_7_5_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_7_5_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>' 
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_6_6_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_6_6_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_6_6_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_6_6_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>' 
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_6_5_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_6_5_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_6_5_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_6_5_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>' 
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_5_5_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_5_5_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_5_5_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_5_5_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>' 
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_5_4_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_5_4_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_5_4_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_5_4_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . $db_row['m_5_4_10_count'] 
			  . '</td>' 
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_4_4_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_4_4_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_4_4_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_4_4_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>' 
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_3_3_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_3_3_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_3_3_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_3_3_1_prze_amt'] * 10) .
			  '</td>'
			  ...
			  . '</td>' 
			  . '<td id="win_amt"  nowrap>' . money_format('%(#12n',$db_row['m_2_2_1_prze_amt']) . '<hr />' 
			  . money_format('%(#12n',$db_row['m_2_2_1_prze_amt'] * 2) . '<hr />'
			  . money_format('%(#12n',$db_row['m_2_2_1_prze_amt'] * 5) . '<hr />'
			  . money_format('%(#12n',$db_row['m_2_2_1_prze_amt'] * 10) .
			  '</td></tr>';
