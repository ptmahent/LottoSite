...
$htmlMainCont .= '<table id="lottery_result" >'
			  . '<thead><tr><th nowrap>Draw Date</th>
			    <th  nowrap>SEQ NUM</th>
			  	<th  nowrap>N1</th>
				<th  nowrap>N2</th>
				<th  nowrap>N3</th>
				<th  nowrap>N4</th>
				...
				<th  nowrap>N7</th>
				<th nowrap>BONUS</th>'
. '<th nowrap colspan="3">7/7 </th><th nowrap  colspan="3">6/7 + Bonus </th>'
. '<th colspan="2">6/7 </th><th nowrap colspan="2">5/7 Match</th>'
. '<th colspan="2">4/7 </th><th nowrap colspan="2">3/7 + Bonus </th>'
. '<th colspan="2">3/7 </th></tr></thead><tbody>';
...
if ($db_row["isequencenum"] == 0) {
  $htmlMainCont .= '<td id="matchBonusNumber">' .  $db_row["snumbonus"] . '</td>';
} else {
	$htmlMainCont .= '<td id="matchBonusNumber">&nbsp;</td>';
}
$htmlMainCont .=  '<td id="winCount">' .  $db_row["m_7_count"] . '</td>'
. '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row['m_7_prze_amt']) . '</td>'
. '<td id="win_amt" nowrap>';
...
if (is_array($db_loc_res)) {
  foreach ($db_loc_res as $db_7_loc) {
    if ($db_7_loc["wnum_m"] == 7) {
      ...
      $htmlMainCont .=  " - " . money_format('%(#12n',$db_7_loc["win_prze_amt"]) . "<br />";
    }
...
$htmlMainCont .= '</td>'
. '<td id="winCount">' . $db_row["m_6_b_count"] . '</td>'
. '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row['m_6_b_prze_amt']) . '</td>'
. '<td id="win_amt" nowrap>';
...
if (is_array($db_loc_res)) {
  foreach ($db_loc_res as $db_6_b_loc) {
    if ($db_6_b_loc["wnum_m"] == 6) {
      ...
      $htmlMainCont .=  " - " . money_format('%(#12n',$db_6_b_loc["win_prze_amt"]) . "<br />";
    }
...
$htmlMainCont .= '</td><td id="winCount">' . $db_row["m_6_count"] . '</td>'
. '<td id="win_amt" nowrap>' . money_format('%(#12n', $db_row["m_6_prze_amt"]) . '</td>';

$htmlMainCont .= '<td id="winCount"' . $db_row["m_5_count"] . '</td>'
. '<td id="win_amt" nowrap>' . money_format('%(#12n', $db_row["m_5_prze_amt"]) . '</td>';

$htmlMainCont .= '<td id="winCount"' . $db_row["m_4_count"] . '</td>'
. '<td id="win_amt" nowrap>' . money_format('%(#12n', $db_row["m_4_prze_amt"]) . '</td>';

$htmlMainCont .= '<td id="winCount"' . $db_row["m_3_b_count"] . '</td>' 
. '<td id="win_amt" nowrap>' . money_format('%(#12n', $db_row["m_3_b_prze_amt"]) . '</td>';

$htmlMainCont .= '<td id="winCount"' . $db_row["m_3_count"] . '</td>'
. '<td id="win_amt" nowrap>' . money_format('%(#12n', $db_row["m_3_prze_amt"]) . '</td></tr>';
