...
if (is_array($db_res)) {
  ...
  $htmlMainCont .= '<tr ><td id="drawDate" nowrap>' . date('Y-m-d',strtotime($db_row["drawdate"])) . "</td>"
				...
				. '<td id="winCount">' . $db_row["m_rf_i_count"] . '
				  ...
				  . $db_row["m_5_d_count"] .
				'</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row["m_rf_i_prze_amt"]) . '<hr />'
				. money_format('%(#12n',$db_row["m_5_d_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_sf_i_count"] . '<hr />'
			    . $db_row["m_4_d_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row["m_sf_i_prze_amt"]) . '<hr />'
				. money_format('%(#12n',$db_row["m_4_d_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_4k_i_count"] . '<hr />'
				. $db_row["m_3_d_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row["m_4k_i_prze_amt"]) . '<hr />'
				 . money_format('%(#12n',$db_row["m_3_d_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_fh_i_count"] . '<hr />'
				. $db_row["m_2_d_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row["m_fh_i_prze_amt"]) . '<hr />'
				. money_format('%(#12n',$db_row["m_2_d_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_f_i_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row["m_f_i_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_s_i_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row["m_s_i_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_3k_i_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row["m_3k_i_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_2p_i_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row["m_2p_i_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_pj_i_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row["m_pj_i_prze_amt"]) . '</td></tr>';
