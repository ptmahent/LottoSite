...
$htmlMainCont .= '<tr ><td id="drawDate" nowrap>' . date('Y-m-d',strtotime($db_row["drawdate"])) . "</td>"
		...
		. '<td id="drawNumber">' . $db_row["snum7"] . '</td>'
			...
			. '<td nowrap id="win_amt">' .  money_format('%(#12n',$db_row["m_7_rl_prze_amt"]) . '
			<hr />' .
			 money_format('%(#12n',$db_row["m_2_lr_prze_amt"]) . '
			</td>'
			. '<td nowrap id="winCount">' . $db_row["m_6_rl_count"] . '
			<hr /> ' . 
			$db_row["m_f5_l1_count"] .
			'</td>'
			. '<td nowrap id="win_amt">' .  money_format('%(#12n',$db_row["m_6_rl_prze_amt"]) . '
			<hr />' .
			 money_format('%(#12n',$db_row["m_f5_l1_prze_amt"])
			 . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_5_rl_count"] . '
			<hr />' . 
			$db_row["m_f4_l2_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_5_rl_prze_amt"]) . '
			<hr />' 
			. money_format('%(#12n',$db_row["m_f4_l2_prze_amt"]) . '</td>' 	   
			. '<td nowrap id="winCount">' . $db_row["m_4_rl_count"] . '
			<hr />' 
			. $db_row["m_f4_l1_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_4_rl_prze_amt"]) . '
			<hr />' . money_format('%(#12n',$db_row["m_f4_l1_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_3_rl_count"] . '
			<hr />' . $db_row["m_f3_l3_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_3_rl_prze_amt"]) . '
			<hr />'  . money_format('%(#12n',$db_row["m_f3_l3_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_2_rl_count"] . '
			<hr />' . $db_row["m_f3_l2_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_2_rl_prze_amt"]) . '
			<hr />' . money_format('%(#12n',$db_row["m_f3_l2_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_1_rl_count"] . '
			<hr />'  . $db_row["m_f3_l1_count"] . '</td>' 
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_1_rl_prze_amt"]) . '
			<hr />' .  money_format('%(#12n',$db_row["m_f3_l1_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_6_lr_count"] . '
			<hr />'  . $db_row["m_f2_l4_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_6_lr_prze_amt"]) . '
			<hr />'  . money_format('%(#12n',$db_row["m_f2_l4_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_5_lr_count"] . '
			<hr />'  . $db_row["m_f2_l3_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_5_lr_prze_amt"]) . '
			<hr />'  . money_format('%(#12n',$db_row["m_f2_l3_prze_amt"]) . '</td>'         
			. '<td nowrap id="winCount">' . $db_row["m_4_lr_count"] . '
			<hr />' . $db_row["m_f2_l2_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_4_lr_prze_amt"]) . '
			<hr />' . money_format('%(#12n',$db_row["m_f2_l2_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_3_lr_count"] . '
			<hr />' . $db_row["m_f2_l1_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_3_lr_prze_amt"]) . '
			<hr />' . money_format('%(#12n',$db_row["m_f2_l1_prze_amt"]) . '</td>'
			. '</tr>'; 
			...
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_2_lr_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f5_l1_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_f5_l1_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f4_l2_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_f4_l2_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f4_l1_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_f4_l1_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f3_l3_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_f3_l3_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f3_l2_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_f3_l2_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f3_l1_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_f3_l1_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f2_l4_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_f2_l4_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f2_l3_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_f2_l3_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f2_l2_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_f2_l2_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f2_l1_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_f2_l1_prze_amt"]) . '</td>'
			. '</tr>';*/
  }
}
