...
$htmlFormStartOut .= '<form name="frmViewLotto" id="frmViewLotto" method="get" action="view_encore_winnings.php">'
...
$htmlMainCont .= '<table id="lottery_result" >'
			  . '<thead><tr><th>Draw Date</th>
				...
				<th >N6</th>
				<th >N7</th> '
			  . '<th colspan="2" nowrap>xxxxxxx
			  <hr />
			  xx_____
			  </th>'
			  . '<th colspan="2"  nowrap>_xxxxxx
			  <hr />
			  xxxxx_x
			  </th>'
			  . '<th colspan="2" nowrap>__xxxxx
			  <hr />
			  xxxx_xx
			  </th>'
			  . '<th colspan="2" nowrap>___xxxx
			  <hr />
			  xxxx__x</th>'                
			  . '<th colspan="2" nowrap>____xxx
			  <hr />xxx_xxx
			  </th>'                
			  . '<th colspan="2" nowrap>_____xx
			  <hr />
			  xxx__xx
			  
			  </th>'
			  . '<th colspan="2" nowrap>______x
			  <hr />
			  xxx___x
			  </th>'    
			  . '<th colspan="2" nowrap>xxxxxx_
			  <hr />
			  xx_xxxx
			  </th>'
			  . '<th colspan="2" nowrap>xxxxx__
			  <hr />
			  xx__xxx
			  </th>'
			  . '<th colspan="2" nowrap>xxxx___
			  <hr />
			  xx___xx
			  </th>'
			  . '<th colspan="2" nowrap>xxx____
			  <hr />
			  xx____x
			  </th>'
			  . '</tr></thead><tbody>';
...
$htmlMainCont .= '<tr ><td id="drawDate" nowrap>' . date('Y-m-d',strtotime($db_row["drawdate"])) . "</td>"
		...
		. '<td id="drawNumber">' . $db_row["snum7"] . '</td>'
			...
			. '<td nowrap id="win_amt">' .  money_format('%(#10.0n',$db_row["m_7_rl_prze_amt"]) . '
			<hr />' .
			 money_format('%(#10.0n',$db_row["m_2_lr_prze_amt"]) . '
			</td>'
			. '<td nowrap id="winCount">' . $db_row["m_6_rl_count"] . '
			<hr /> ' . 
			$db_row["m_f5_l1_count"] .
			'</td>'
			. '<td nowrap id="win_amt">' .  money_format('%(#10.0n',$db_row["m_6_rl_prze_amt"]) . '
			<hr />' .
			 money_format('%(#10.0n',$db_row["m_f5_l1_prze_amt"])
			 . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_5_rl_count"] . '
			<hr />' . 
			$db_row["m_f4_l2_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_5_rl_prze_amt"]) . '
			<hr />' 
			. money_format('%(#10.0n',$db_row["m_f4_l2_prze_amt"]) . '</td>' 	   
			. '<td nowrap id="winCount">' . $db_row["m_4_rl_count"] . '
			<hr />' 
			. $db_row["m_f4_l1_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_4_rl_prze_amt"]) . '
			<hr />' . money_format('%(#10.0n',$db_row["m_f4_l1_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_3_rl_count"] . '
			<hr />' . $db_row["m_f3_l3_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_3_rl_prze_amt"]) . '
			<hr />'  . money_format('%(#10.0n',$db_row["m_f3_l3_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_2_rl_count"] . '
			<hr />' . $db_row["m_f3_l2_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_2_rl_prze_amt"]) . '
			<hr />' . money_format('%(#10.0n',$db_row["m_f3_l2_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_1_rl_count"] . '
			<hr />'  . $db_row["m_f3_l1_count"] . '</td>' 
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_1_rl_prze_amt"]) . '
			<hr />' .  money_format('%(#10.0n',$db_row["m_f3_l1_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_6_lr_count"] . '
			<hr />'  . $db_row["m_f2_l4_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_6_lr_prze_amt"]) . '
			<hr />'  . money_format('%(#10.0n',$db_row["m_f2_l4_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_5_lr_count"] . '
			<hr />'  . $db_row["m_f2_l3_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_5_lr_prze_amt"]) . '
			<hr />'  . money_format('%(#10.0n',$db_row["m_f2_l3_prze_amt"]) . '</td>'         
			. '<td nowrap id="winCount">' . $db_row["m_4_lr_count"] . '
			<hr />' . $db_row["m_f2_l2_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_4_lr_prze_amt"]) . '
			<hr />' . money_format('%(#10.0n',$db_row["m_f2_l2_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_3_lr_count"] . '
			<hr />' . $db_row["m_f2_l1_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_3_lr_prze_amt"]) . '
			<hr />' . money_format('%(#10.0n',$db_row["m_f2_l1_prze_amt"]) . '</td>'
			. '</tr>'; 
			...
			/*<tr>'
			. '<td nowrap id="winCount">' . $db_row["m_2_lr_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_2_lr_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f5_l1_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_f5_l1_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f4_l2_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_f4_l2_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f4_l1_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_f4_l1_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f3_l3_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_f3_l3_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f3_l2_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_f3_l2_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f3_l1_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_f3_l1_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f2_l4_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_f2_l4_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f2_l3_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_f2_l3_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f2_l2_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_f2_l2_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_f2_l1_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#10.0n',$db_row["m_f2_l1_prze_amt"]) . '</td>'
			. '</tr>';*/
  }
}
