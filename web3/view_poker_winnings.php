...
$htmlMainCont .= '<table id="lottery_result" >'
			  ...
			  . '<th>CARD 4</th>'
			  . '<th>CARD 5</th>'
			. '<th colspan="2" nowrap>Royal Flush
			<hr />5/5 Match</th>'
			. '<th colspan="2" nowrap>Straight Flush
			<hr />
			4/5 Match</th>'
			. '<th colspan="2" nowrap>4 of a Kind
			<hr />
			3/5 Match</th>'
			. '<th colspan="2" nowrap>Full House
			<hr />
			2/5 Match</th>'
			. '<th colspan="2" nowrap>Flush</th>'
			. '<th colspan="2" nowrap>Straight</th>'
			. '<th colspan="2" nowrap>3 of a Kind</th>'
			. '<th colspan="2" nowrap>2 Pair</th>'
			. '<th colspan="2" nowrap>Pair of Jacks or Better</th>'
			. '</tr></thead><tbody';
...
if (is_array($db_res)) {
  ...
  $htmlMainCont .= '<tr ><td id="drawDate" nowrap>' . date('Y-m-d',strtotime($db_row["drawdate"])) . "</td>"
				...
				. '<td id="winCount">' . $db_row["m_rf_i_count"] . '
					<hr />'
				  . $db_row["m_5_d_count"] .
				'</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#10.0n',$db_row["m_rf_i_prze_amt"]) . '<hr />'
				. money_format('%(#10.0n',$db_row["m_5_d_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_sf_i_count"] . '<hr />'
			    . $db_row["m_4_d_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#10.0n',$db_row["m_sf_i_prze_amt"]) . '<hr />'
				. money_format('%(#10.0n',$db_row["m_4_d_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_4k_i_count"] . '<hr />'
				. $db_row["m_3_d_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#10.0n',$db_row["m_4k_i_prze_amt"]) . '<hr />'
				 . money_format('%(#10.0n',$db_row["m_3_d_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_fh_i_count"] . '<hr />'
				. $db_row["m_2_d_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#10.0n',$db_row["m_fh_i_prze_amt"]) . '<hr />'
				. money_format('%(#10.0n',$db_row["m_2_d_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_f_i_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#10.0n',$db_row["m_f_i_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_s_i_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#10.0n',$db_row["m_s_i_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_3k_i_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#10.0n',$db_row["m_3k_i_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_2p_i_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#10.0n',$db_row["m_2p_i_prze_amt"]) . '</td>'
				. '<td id="winCount">' . $db_row["m_pj_i_count"] . '</td>'
				. '<td id="win_amt" nowrap>' . money_format('%(#10.0n',$db_row["m_pj_i_prze_amt"]) . '</td></tr>';
