...
if (is_array($lotto_validat_res)) {
  ...
  foreach ($lotto_validat_res as $lotto_single_game) {
      ...
      foreach ($lotto_single_game["validation_res"] as $s_single_match) {
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<td id='matchNumber'>" . $lotto_single_game["played_nums"][0][0] . "<sub>&nbsp;&nbsp;Y</sub></td>";
          } elseif ($b_bonus_num_match) {
            $htmlOut .= "<td id='matchBonusNumber'>" . $lotto_single_game["played_nums"][0][0] . "<sub>&nbsp;&nbsp;B</sub></td>";
             
          } else {
            $htmlOut .= "<td id='notMatchNumber'>" . $lotto_single_game["played_nums"][0][0] . "<sub>&nbsp;&nbsp;N</sub></td>";
          }
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<td id='matchNumber'>" . $lotto_single_game["played_nums"][0][1] . "<sub>&nbsp;&nbsp;Y</sub></td>";
          } elseif ($b_bonus_num_match) {
            $htmlOut .= "<td id='matchBonusNumber'>" . $lotto_single_game["played_nums"][0][1] . "<sub>&nbsp;&nbsp;B</sub></td>";
             
          } else {
            $htmlOut .= "<td id='notMatchNumber'>" . $lotto_single_game["played_nums"][0][1] . "<sub>&nbsp;&nbsp;N</sub></td>";
          }
        ...
        $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<td id='matchNumber'>" . $lotto_single_game["played_nums"][0][2] . "<sub>&nbsp;&nbsp;Y</sub></td>";
          } elseif ($b_bonus_num_match) {
            $htmlOut .= "<td id='matchBonusNumber'>" . $lotto_single_game["played_nums"][0][2] . "<sub>&nbsp;&nbsp;B</sub></td>";
             
          } else {
            $htmlOut .= "<td id='notMatchNumber'>" . $lotto_single_game["played_nums"][0][2] . "<sub>&nbsp;&nbsp;N</sub></td>";
          }
        ...
        $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<td id='matchNumber'>" . $lotto_single_game["played_nums"][0][3] . "<sub>&nbsp;&nbsp;Y</sub></td>";
          } elseif ($b_bonus_num_match) {
            $htmlOut .= "<td id='matchBonusNumber'>" . $lotto_single_game["played_nums"][0][3] . "<sub>&nbsp;&nbsp;B</sub></td>";
             
          } else {
            $htmlOut .= "<td id='notMatchNumber'>" . $lotto_single_game["played_nums"][0][3] . "<sub>&nbsp;&nbsp;N</sub></td>";
          }    
        ...
        $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<td id='matchNumber'>" . $lotto_single_game["played_nums"][0][4] . "<sub>&nbsp;&nbsp;Y</sub></td>";
          } elseif ($b_bonus_num_match) {
            $htmlOut .= "<td id='matchBonusNumber'>" . $lotto_single_game["played_nums"][0][4] . "<sub>&nbsp;&nbsp;B</sub></td>";
             
          } else {
            $htmlOut .= "<td id='notMatchNumber'>" . $lotto_single_game["played_nums"][0][4] . "<sub>&nbsp;&nbsp;N</sub></td>";
          }    
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<td id='matchNumber'>" . $lotto_single_game["played_nums"][0][5] . "<sub>&nbsp;&nbsp;Y</sub></td>";
          } elseif ($b_bonus_num_match) {
            $htmlOut .= "<td id='matchBonusNumber'>" . $lotto_single_game["played_nums"][0][5] . "<sub>&nbsp;&nbsp;B</sub></td>";
             
          } else {
            $htmlOut .= "<td id='notMatchNumber'>" . $lotto_single_game["played_nums"][0][5] . "<sub>&nbsp;&nbsp;N</sub></td>";
          }
         ...
         if (is_array($s_single_match["played_nums"][1])) {
	        ...
	        $b_win_num_match = false;
          	...
          	if ($b_win_num_match) {
            	$htmlOut .= "<td id='matchNumber'>" . $lotto_single_game["played_nums"][1][0] . "<sub>&nbsp;&nbsp;Y</sub></td>";
          	} else {
            	$htmlOut .= "<td id='notMatchNumber'>" . $lotto_single_game["played_nums"][1][0] . "<sub>&nbsp;&nbsp;N</sub></td>";
          	}
         ...
         $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<td id='matchNumber'>" . $lotto_single_game["played_nums"][1][1] . "<sub>&nbsp;&nbsp;Y</sub></td>";
          } else {
            $htmlOut .= "<td id='notMatchNumber'>" . $lotto_single_game["played_nums"][1][1] . "<sub>&nbsp;&nbsp;N</sub></td>";
          }
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<td id='matchNumber'>" . $lotto_single_game["played_nums"][1][2] . "<sub>&nbsp;&nbsp;Y</sub></td>";
          } else {
            $htmlOut .= "<td id='notMatchNumber'>" . $lotto_single_game["played_nums"][1][2] . "<sub>&nbsp;&nbsp;N</sub></td>";
          }
         ...
         $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<td id='matchNumber'>" . $lotto_single_game["played_nums"][1][3] . "<sub>&nbsp;&nbsp;Y</sub></td>";
          } else {
            $htmlOut .= "<td id='notMatchNumber'>" . $lotto_single_game["played_nums"][1][3] . "<sub>&nbsp;&nbsp;N</sub></td>";
          }
