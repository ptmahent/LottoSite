...
$htmlFormStartOut .= '<form name="frmViewLotto" id="frmViewLotto" method="get" action="view_49_winnings.php">'
...
$htmlMainCont .= '<table id="lottery_result" >'
			  . '<thead><tr><th>Draw Date</th>
				...
				<th>N6</th>
				<th>BONUS</th>
			 	<th  nowrap colspan="2">6/6 </th>'
			  . '<th  nowrap colspan="2">5/6 + </th><th  nowrap colspan="2">5/6 </th><th  nowrap colspan="2">4/6 </th>'
			  . '<th  nowrap colspan="2">3/6 </th></tr></thead>'
			  . '<tbody>';
 ...
 * 
 */
$db_res = $OLGLottery->OLG49WinningsGetDraw($st_date, $ed_date, $st_row_num, $ed_row_num);
//print_r($db_res);
if (is_array($db_res)) {
  foreach ($db_res as $db_row) {
  
	$htmlMainCont .= "<tr ><td id='drawDate' nowrap>" . date('Y-m-d',strtotime($db_row["drawdate"])) . "</td>"
				  . "<td id='drawNumber'>" . $db_row["snum1"] . "</td><td id='drawNumber'>" . $db_row["snum2"] . "</td><td id='drawNumber'>" . $db_row["snum3"] . "</td><td id='drawNumber'>" . $db_row["snum4"] 
				   . "</td><td id='drawNumber'>" . $db_row["snum5"] . "</td><td id='drawNumber'>" . $db_row["snum6"] . "</td><td id='matchBonusNumber'>" . $db_row["snumbonus"] . "</td>";

	$htmlMainCont .= '<td id="winCount">' . $db_row["m_6_count"] . '</td>'
				  . '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row['m_6_prze_amt']) . '</td>'
				  . '<td id="winCount">' . $db_row["m_5_b_count"] . '</td>'
				  . '<td id="win_amt" nowrap>' . money_format('%(#12n',$db_row['m_5_b_prze_amt']) . '</td>'
				  . '<td id="winCount">' . $db_row["m_5_count"] . '</td>'
				  . '<td id="win_amt" nowrap>' . money_format('%(#12n', $db_row["m_5_prze_amt"]) . '</td>'
				  . '<td id="winCount">' . $db_row["m_4_count"] . '</td>'
