...
if ($lotto_validat_res != null && is_array($lotto_validat_res)) {
  $icur_game_cnt = 0;
  ...
  foreach ($lotto_validat_res as $lotto_single_game) {
      ...
      foreach ($lotto_single_game["validation_res"] as $s_single_match) {
       ...
       if ($b_win_num_match) {
        ...
        $htmlOut .= "<td id='" . $style_id . "'>" . $lotto_single_game["played_nums"][0] . $NumStatus . "</td>";
       ...
       if ($s_single_match["category"] >= 2) {
        ...
        $htmlOut .= "<td id='" . $style_id . "'>" . $lotto_single_game["played_nums"][1] . $NumStatus . "</td>";
       ...
       if ($s_single_match["category"] >= 3) {
        ...
        $htmlOut .= "<td id='" . $style_id . "'>" . $lotto_single_game["played_nums"][2] . $NumStatus . "</td>";
      ...
      $NumStatus = "";
       if ($s_single_match["category"] >= 4) {
        ...
        $htmlOut .= "<td id='" . $style_id . "'>" . $lotto_single_game["played_nums"][3] . $NumStatus . "</td>";
       ...
       if ($s_single_match["category"] >= 5) {
        ...
        $htmlOut .= "<td id='" . $style_id . "'>" . $lotto_single_game["played_nums"][4] . $NumStatus . "</td>";
       ...
       if ($s_single_match["category"] >= 6) {
        ...
        $htmlOut .= "<td id='" . $style_id . "'>" . $lotto_single_game["played_nums"][5] . $NumStatus . "</td>";
      ...
      if ($s_single_match["category"] >= 7) {
        ...
        $htmlOut .= "<td id='" . $style_id . "'>" . $lotto_single_game["played_nums"][6] . $NumStatus . "</td>";
       ...
       if ($s_single_match["category"] >= 8) {
        ...
        $htmlOut .= "<td id='" . $style_id . "'>" . $lotto_single_game["played_nums"][7] . $NumStatus . "</td>";
       ...
       if ($s_single_match["category"] >= 9) {
        ...
        $htmlOut .= "<td id='" . $style_id . "'>" . $lotto_single_game["played_nums"][8] . $NumStatus . "</td>";
       ...
       if ($s_single_match["category"] >= 10) {
        ...
        $htmlOut .= "<td id='" . $style_id . "'>" . $lotto_single_game["played_nums"][9] . $NumStatus . "</td>";
