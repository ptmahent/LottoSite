...
$htmlMainCont .= '<table id="lottery_result" >'
			  . '<thead><tr><th>Draw Date</th>
				...
				<th>EB4</th>
				<th>&nbsp;</th>
				<th colspan="2">6/6</th><th colspan="2">5/6 + Bonus</th>'
. '<th colspan="2">5/6</th><th colspan="2">4/6</th><th colspan="2">3/6</th>'
. '<th colspan="2">Early Bird</th></tr></thead><tbody>';
...
. '<td id="drawNumber">' .  $db_row["eb_snum4"] . '</td>'
 . '<td id="winCount">' . $db_row["m_6_count"] . '</td>'
 ...
 . '<td id="winCount">' . $db_row["m_3_count"] . '</td>'
 . '<td id="win_amt" nowrap>' . money_format('%(#12n', $db_row["m_3_prze_amt"]) . '</td>'
 . '<td id="winCount">' . $db_row["m_e_bird_count"] . '</td>'
 . '<td id="win_amt" nowrap>' . money_format('%(#12n', $db_row["m_e_bird_prze_amt"]) . '</td>'
 . '</tr>';
