...
<body>
<form name="frmViewLotto" method="get" action="view_pick4_winnings.php">
...
<td colspan="2">Straight Match</td>
<td colspan="2">4  Way Box</td>
<td colspan="2">6  Way Box</td>
<td colspan="2">12 Way Box</td>
<td colspan="2">24 Way Box</td>
</tr>
<?php
/*
print "st DT: " . $st_date;
...
<td><?php print $db_row["snum1"] . "-" . $db_row["snum2"] . "-" . $db_row["snum3"] . "-" .$db_row["snum4"]; ?>
</td>

<td><?php print $db_row["m_4_s_count"]; // NUM1 ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_4_s_prze_amt"]); // NUM2 ?></span></td>

<td><?php print $db_row["m_4_4w_box_count"]; // NUM3 ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_4_4w_box_prze_amt"]); // NUM4 ?></span></td>
<td><?php print $db_row["m_4_6w_box_count"]; // NUM3 ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_4_6w_box_prze_amt"]); // NUM4 ?></span></td>
<td><?php print $db_row["m_4_12w_box_count"]; // NUM3 ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_4_12w_box_prze_amt"]); // NUM4 ?></span></td>
<td><?php print $db_row["m_4_24w_box_count"]; // NUM3 ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_4_24w_box_prze_amt"]); // NUM4 ?></span></td>
