...
<body>
<form name="frmViewLotto" method="get" action="view_lottario_winnings.php">
...
<td colspan="2">Match 6</td>
<td colspan="2">Match 5 + Bonus</td>
<td colspan="2">Match 5</td>
<td colspan="2">Match 4</td>
<td colspan="2">Match 3</td>
<td colspan="2">Match Early Bird</td>
</tr>
<?php
/*
print "st DT: " . $st_date;
...
print "<br />EB: " . $db_row["eb_snum1"] . "-" . $db_row["eb_snum2"] . "-" . $db_row["eb_snum3"] . "-" . $db_row["eb_snum4"]; 
?></td>


<td><?php print $db_row["m_6_count"]; // NUM1 ?></td>
<td><?php print $db_row["m_6_prze_amt"]; // NUM2 ?></td>
<td><?php print $db_row["m_5_b_count"]; // NUM3 ?></td>
<td><?php print $db_row["m_5_b_prze_amt"]; // NUM4 ?></td>
<td><?php print $db_row["m_5_count"]; // NUM3 ?></td>
<td><?php print $db_row["m_5_prze_amt"]; // NUM4 ?></td>
<td><?php print $db_row["m_4_count"]; // NUM5 ?></td>
<td><?php print $db_row["m_4_prze_amt"]; // NUM6 ?></td>
<td><?php print $db_row["m_3_count"]; // BONUSNUM ?></td>
<td><?php print $db_row["m_3_prze_amt"]; ?></td>
<td><?php print $db_row["m_e_bird_count"]; ?></td>
<td><?php print $db_row["m_e_bird_prze_amt"]; ?></td>
</tr>
