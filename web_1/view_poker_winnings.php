...
<body>
<form name="frmViewLotto" method="get" action="view_poker_winnings.php">
...
<td rowspan="2">Winning Cards</td>
<td colspan="2">Royal Flush</td>
<td colspan="2">Straight Flush</td>
<td colspan="2">4 of a Kind</td>
<td colspan="2">Full House</td>
<td colspan="2">Flush</td>
<td colspan="2">Straight</td>
<td colspan="2">3 of a Kind</td>
<td colspan="2">2 Pair</td>
<td colspan="2">Pair of Jacks or Better</td>
</tr>

<tr>
<td colspan="2">5/5 Match</td>
<td colspan="2">4/5 Match</td>
<td colspan="2">3/5 Match</td>
<td colspan="12" >2/5 Match</td>
 ...
 * 
 */
$db_res = $OLGLottery->OLGPokerWinningsGetDraw($st_date, $ed_date, $st_row_num, $ed_row_num);
//print_r($db_res);
if (is_array($db_res)) {
...
<tr class="649Row">
<td rowspan="2"><?php print date('Y-m-d',strtotime($db_row["drawdate"])); // drawdate ?></td>
<td rowspan="2"><?php print $db_row["scard1"] . "-" . $db_row["scard2"] . "-" . $db_row["scard3"] . "-" . $db_row["scard4"] . "-" . $db_row["scard5"]; // NUM1 ?></td>
<td><?php print $db_row["m_rf_i_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_rf_i_prze_amt"]); ?></span></td>
<td><?php print $db_row["m_sf_i_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_sf_i_prze_amt"]); ?></span></td>
<td><?php print $db_row["m_4k_i_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_4k_i_prze_amt"]); ?></span></td>
<td><?php print $db_row["m_fh_i_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_fh_i_prze_amt"]); ?></span></td>
<td><?php print $db_row["m_f_i_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_f_i_prze_amt"]); ?></span></td>
<td><?php print $db_row["m_s_i_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_s_i_prze_amt"]); ?></span></td>
<td><?php print $db_row["m_3k_i_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_3k_i_prze_amt"]); ?></span></td>
<td><?php print $db_row["m_2p_i_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_2p_i_prze_amt"]); ?></span></td>
<td><?php print $db_row["m_pj_i_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_pj_i_prze_amt"]); ?></span></td>

</tr>
<tr>
<td><?php print $db_row["m_5_d_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_5_d_prze_amt"]); ?></span></td>
<td><?php print $db_row["m_4_d_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_4_d_prze_amt"]); ?></span></td>
<td><?php print $db_row["m_3_d_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_3_d_prze_amt"]); ?></span></td>
<td ><?php print $db_row["m_2_d_count"]; ?></td>
<td colspan="11"><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_2_d_prze_amt"]); ?></span></td>
