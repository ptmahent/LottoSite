...
<body>
<form name="frmViewLotto" method="get" action="view_pick3_winnings.php">
...
<td>
<?php print $db_row["snum1"] . "-" . $db_row["snum2"] . "-" . $db_row["snum3"]; ?>

</td>

<td><?php print $db_row["m_3_s_count"]; // NUM1 ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_3_s_prze_amt"]); // NUM2 ?></span></td>
<td><?php print $db_row["m_3_b_count"]; // NUM3 ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row["m_3_b_prze_amt"]); // NUM4 ?></span></td>
</tr>
