...
<body>
<form name="frmViewLotto" method="get" action="view_keno.php">
...
<td colspan="20">Winning Number</td>
<td>Winnings</td>
</tr>
<?php
/*
...
<td><?php print $db_row["snum7"]; // NUM7 ?></td>
<td><?php print $db_row["snum8"]; // NUM8 ?></td>
<td><?php print $db_row["snum9"]; // NUM9 ?></td>
<td><?php print $db_row["snum10"]; // NUM10 ?></td>
<td><?php print $db_row["snum11"]; // NUM1 ?></td>
<td><?php print $db_row["snum12"]; // NUM2 ?></td>
<td><?php print $db_row["snum13"]; // NUM3 ?></td>
<td><?php print $db_row["snum14"]; // NUM4 ?></td>
<td><?php print $db_row["snum15"]; // NUM5 ?></td>
<td><?php print $db_row["snum16"]; // NUM6 ?></td>
<td><?php print $db_row["snum17"]; // NUM7 ?></td>
<td><?php print $db_row["snum18"]; // NUM8 ?></td>
<td><?php print $db_row["snum19"]; // NUM9 ?></td>
<td><?php print $db_row["snum20"]; // NUM10 ?></td>
