...
<body>
<form name="frmViewLotto" method="get" action="view_max_winnings.php">
...
<td colspan="3">7/7 Match</td>
<td colspan="3">6/7 + Bonus Match</td>
<td colspan="2">6/7 Match</td>
<td colspan="2">5/7 Match</td>
<td colspan="2">4/7 Match</td>
<td colspan="2">3/7 + Bonus Match</td>
<td colspan="2">3/7 Match</td>
...
<td><?php print $db_row["isequencenum"]; ?></td>
<td><?php 

print $db_row["snum1"] . "-" . $db_row["snum2"] . "-" . $db_row["snum3"] . "-" . $db_row["snum4"] . "-" . $db_row["snum5"] . "-" . $db_row["snum6"] . "-" . $db_row["snum7"];

if ($db_row["isequencenum"] == 0) {
  print " Bonus: " . $db_row["snumbonus"];
}
?> </td>
<td><?php print $db_row["m_7_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n',$db_row['m_7_prze_amt']); ?></span></td>
<td><?php
...
if (is_array($db_loc_res)) {
  foreach ($db_loc_res as $db_7_loc) {
    if ($db_7_loc["wnum_m"] == 7) {
      print $db_7_loc["win_loc"] . " - " . $db_7_loc["wcount"];
      print " - <span class='win_amt'>$" . money_format('%(#12n',$db_7_loc["win_prze_amt"]) . "</span><br />";
    }
...
?></td>
<td><?php  print $db_row["m_6_b_count"]; ?></td>
<td><span class='win_amt'>$<?php  print money_format('%(#12n',$db_row['m_6_b_prze_amt']); ?></span></td>
<td><?php
if (is_array($db_loc_res)) {
  foreach ($db_loc_res as $db_6_b_loc) {
    if ($db_6_b_loc["wnum_m"] == 6) {
      print $db_6_b_loc["win_loc"] . " - " . $db_6_b_loc["wcount"];
      print " - <span class='win_amt'>$" . money_format('%(#12n',$db_6_b_loc["win_prze_amt"]) . "</span><br />";
    }
...
<td><span class='win_amt'>$<?php  print money_format('%(#12n', $db_row["m_5_prze_amt"]); ?></span></td>

<td><?php  print $db_row["m_4_count"]; ?></td>
<td><span class='win_amt'>$<?php  print money_format('%(#12n', $db_row["m_4_prze_amt"]); ?></span></td>

<td><?php  print $db_row["m_3_b_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n', $db_row["m_3_b_prze_amt"]); ?></span></td>

<td><?php  print $db_row["m_3_count"]; ?></td>
<td><span class='win_amt'>$<?php print money_format('%(#12n', $db_row["m_3_prze_amt"]); ?></span></td>
