...
$htmlMainCont .= '<div id="game_draw_body"><table border="0" colspan="0" width="100%">'
			  . '<tr><td>Draw Date</td><td colspan="2">Straight Match</td><td colspan="2">Box Match</td>'
			  . '<td colspan="2">4  Way Box</td><td colspan="2">6  Way Box</td><td colspan="2">12 Way Box</td>'
			  . '<td colspan="2">24 Way Box</td></tr>';
/*
print "st DT: " . $st_date;
print "\n ed DT: " . $ed_date;
print "\n stRowNum: " . $st_row_num;
...
if (is_array($db_res)) {
  foreach ($db_res as $db_row) {
	$htmlMainCont .= '<tr class="649Row"><td>' . date('Y-m-d',strtotime($db_row["drawdate"])) . '</td>'
			 	  . '<td>' . $db_row["m_4_s_count"] . '</td>'
				  . '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_4_s_prze_amt"]) . '</span></td>'
				  . '<td>' . $db_row["m_4_b_count"] . '</td>'
				  . '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_4_b_prze_amt"]) . '</span></td>'
				  . '<td>' . $db_row["m_4_4w_box_count"] . '</td>'
				  . '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_4_4w_box_prze_amt"]) . '</span></td>'
				  . '<td>' . $db_row["m_4_6w_box_count"] . '</td>'
				  . '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_4_6w_box_prze_amt"]) . '</span></td>'
				  . '<td>' . $db_row["m_4_12w_box_count"] . '</td>'
				  . '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_4_12w_box_prze_amt"]) . '</span></td>'
				  . '<td>' . $db_row["m_4_24w_box_count"] . '</td>'
				  . '<td><span class="win_amt">' . money_format('%(#12n',$db_row["m_4_24w_box_prze_amt"]) . '</span></td>'
				  . '</tr>';
  }
}
