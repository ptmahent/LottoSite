...
$sQuickPick4  =  implode("-",$QuickPick->OLGKenoQuickPick(9)) ;
...
$sQuickPick10 =  implode("-",$QuickPick->OLGKenoQuickPick(9)) ;
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 9 : ' .  $sQuickPick4  . '</h3></td></tr>';
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 9 : ' .  $sQuickPick10 . '</h3></td></tr>';
