...
$objRetResultChkBx = $objLottoKeno->addField("return_result", "Compare wins Bigger Than: ", VFORM_RADIO_LIST,
        array(
                "required" => true
        ),
        array(
                "required" => "Choose the return Result Type!"
        )
);
        $objRetResultChkBx->addField("Everything", "any", true);
        $objRetResultChkBx->addField("Bigger Than $0", "moreThan0");  // HTML output: <option value="bored" selected="selected">I got bored.</option>
        $objRetResultChkBx->addField("Bigger Than $20", "moreThan20");
        $objRetResultChkBx->addField("Bigger Than $100", "moreThan100");
        $objRetResultChkBx->addField("Bigger Than $300", "moreThan300");
        $objRetResultChkBx->addField("Bigger Than $1000", "moreThan1000");
      */  
  ...
  if ($objForm->isSubmitted() && $objForm->isValid()) {
     ...
     // mail("owner@awesomesite.com", "Contact form submitted", $strMessage, $strHeaders);
      ...
      //$returnDataAmt = $objRetResultChkBx->getValue();
      //print "<hr />" . $returnDataAmt;
