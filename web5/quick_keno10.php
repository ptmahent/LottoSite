...
$htmlFormStartOut .= '<form name="Check_Keno" id="Check_Keno" method="post" enctype="multipart/form-data" action="check_keno.php" >';
...
$sQuickPick1  =  implode("-",$QuickPick->OLGKenoQuickPick(10));
$sQuickPick2  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick3  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick4  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick5  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick6  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick7  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick8  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick9  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick10 =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
...
<input type="hidden" name="addKenoNums" value="on" />

<input type="hidden" name="OLG_Keno" value="' . $sQuickPick1 . '" />
<input type="hidden" name="OLG_Keno_2" value="' . $sQuickPick2 . '" />
<input type="hidden" name="OLG_Keno_3" value="' . $sQuickPick3 . '" />
<input type="hidden" name="OLG_Keno_4" value="' . $sQuickPick4 . '" />
<input type="hidden" name="OLG_Keno_5" value="' . $sQuickPick5 . '" />
<input type="hidden" name="OLG_Keno_6" value="' . $sQuickPick6 . '" />
<input type="hidden" name="OLG_Keno_7" value="' . $sQuickPick7 . '" />
<input type="hidden" name="OLG_Keno_8" value="' . $sQuickPick8 . '" />
<input type="hidden" name="OLG_Keno_9" value="' . $sQuickPick9 . '" />
<input type="hidden" name="OLG_Keno_10" value="' . $sQuickPick10 . '" />
<input type="hidden" name="vf__dispatch" value="Check_Keno" />&nbsp;
</td></tr>

';

$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' . $sQuickPick1  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' .  $sQuickPick2 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' . $sQuickPick3 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' .  $sQuickPick4  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' . $sQuickPick5 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' .  $sQuickPick6 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' . $sQuickPick7 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' . $sQuickPick8  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' . $sQuickPick9 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' .  $sQuickPick10 . '</h3></td></tr>';
...
$smarty->display('quick_numbers_keno.tpl');
