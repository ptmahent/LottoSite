...
$htmlMainCont .= '<table id="lottery_result" >'
			  . '<thead><tr><th rowspan="2">Draw Date</th>
			  	<th rowspan="2">N1</th>
				<th rowspan="2">N2</th>
				<th rowspan="2">N3</th>
				<th rowspan="2">N4</th>
				...
				<th rowspan="2">N6</th>
				<th rowspan="2">N7</th> '
			  . '<th colspan="24"><table border="0"><tr>'
			  ...
			  . '<td colspan="2">xx____x</td></tr></table></th>'
			  . '</tr></thead><tbody>';
/*
print "st DT: " . $st_date;
print "\n ed DT: " . $ed_date;
...
$htmlMainCont .= '<tr ><td id="drawDate" nowrap>' . date('Y-m-d',strtotime($db_row["drawdate"])) . "</td>"
		...
		. '<td id="winCount" colspan="24"><table border="0"><tr>' 
			. '<td nowrap id="winCount">' . $db_row["m_7_rl_count"] . '</td>'
			. '<td nowrap id="win_amt">' .  money_format('%(#12n',$db_row["m_7_rl_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_6_rl_count"] . '</td>'
			. '<td nowrap id="win_amt">' .  money_format('%(#12n',$db_row["m_6_rl_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_5_rl_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_5_rl_prze_amt"]) . '</td>' 	   
			. '<td nowrap id="winCount">' . $db_row["m_4_rl_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_4_rl_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_3_rl_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_3_rl_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_2_rl_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_2_rl_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_1_rl_count"] . '</td>' 
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_1_rl_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_6_lr_count"] . '</td>'
			. '<td nowrap id=="win_amt">' . money_format('%(#12n',$db_row["m_6_lr_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_5_lr_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_5_lr_prze_amt"]) . '</td>'         
			. '<td nowrap id="winCount">' . $db_row["m_4_lr_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_4_lr_prze_amt"]) . '</td>'
			. '<td nowrap id="winCount">' . $db_row["m_3_lr_count"] . '</td>'
			. '<td nowrap id="win_amt">' . money_format('%(#12n',$db_row["m_3_lr_prze_amt"]) . '</td>'
			. '</tr><tr>'
