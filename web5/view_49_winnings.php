...
$htmlMainCont .= '<table id="lottery_result" >'
			  . '<thead><tr><th>Draw Date</th>
				...
				<th>N6</th>
				<th>BONUS</th>
			 	<th >6/6 Count</th><th >6/6 Amount</th>'
			  . '<th >5/6 + Count</th><th >5/6 + Amount</th><th >5/6 Count</th>'
			  . '<th >5/6 Amount</th><th >4/6 Count</th><th >4/6 Amount</th>'
			  . '<th >3/6 Count</th><th >3/6 Amount</th></tr></thead>'
			  . '<tbody>';
...
if (is_array($db_res)) {
  foreach ($db_res as $db_row) {
	...
	$htmlMainCont .= '<td id="winCount">' . $db_row["m_6_count"] . '</td>'
				  ...
				  . '<td id="win_amt">' . money_format('%(#12n', $db_row["m_4_prze_amt"]) . '</td>';
