...
$sQuickPick3  =  implode("-",$QuickPick->OLGKenoQuickPick(8)) ;
$sQuickPick4  =  implode("-",$QuickPick->OLGKenoQuickPick(7)) ;
$sQuickPick5  =  implode("-",$QuickPick->OLGKenoQuickPick(6)) ;
$sQuickPick6  =  implode("-",$QuickPick->OLGKenoQuickPick(5)) ;
$sQuickPick7  =  implode("-",$QuickPick->OLGKenoQuickPick(4)) ;
$sQuickPick8  =  implode("-",$QuickPick->OLGKenoQuickPick(3)) ;
$sQuickPick9  =  implode("-",$QuickPick->OLGKenoQuickPick(4)) ;
$sQuickPick10 =  implode("-",$QuickPick->OLGKenoQuickPick(5)) ;
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 8 : ' . $sQuickPick3 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 7 : ' .  $sQuickPick4  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 6 : ' . $sQuickPick5 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 5 : ' .  $sQuickPick6 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 4 : ' . $sQuickPick7 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 3 : ' . $sQuickPick8  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 4 : ' . $sQuickPick9 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 5 : ' .  $sQuickPick10 . '</h3></td></tr>';
