...
$htmlFormStartOut .= '<form name="Check_Keno" id="Check_Keno" method="post" enctype="multipart/form-data" action="check_49.php">';
...
$sQuickPick1  =  implode("-",$QuickPick->OLG49QuickPick());
$sQuickPick2  =  implode("-",$QuickPick->OLG49QuickPick()) ;
$sQuickPick3  =  implode("-",$QuickPick->OLG49QuickPick()) ;
$sQuickPick4  =  implode("-",$QuickPick->OLG49QuickPick()) ;
$sQuickPick5  =  implode("-",$QuickPick->OLG49QuickPick()) ;
$sQuickPick6  =  implode("-",$QuickPick->OLG49QuickPick()) ;
$sQuickPick7  =  implode("-",$QuickPick->OLG49QuickPick()) ;
$sQuickPick8  =  implode("-",$QuickPick->OLG49QuickPick()) ;
$sQuickPick9  =  implode("-",$QuickPick->OLG49QuickPick()) ;
$sQuickPick10 =  implode("-",$QuickPick->OLG49QuickPick()) ;
...
<input type="hidden" name="add49nums" value="on" />

<input type="hidden" name="OLG_49" value="' . $sQuickPick1 . '" />

<input type="hidden" name="OLG_49_2" value="' . $sQuickPick2 . '" />

<input type="hidden" name="OLG_49_3" value="' . $sQuickPick3 . '" />

<input type="hidden" name="OLG_49_4" value="' . $sQuickPick4 . '" />

<input type="hidden" name="OLG_49_5" value="' . $sQuickPick5 . '" />

<input type="hidden" name="OLG_49_6" value="' . $sQuickPick6 . '" />


<input type="hidden" name="OLG_49_8" value="' . $sQuickPick8 . '" />

<input type="hidden" name="OLG_49_9" value="' . $sQuickPick9 . '" />

<input type="hidden" name="OLG_49_10" value="' . $sQuickPick10 . '" />

<input type="hidden" name="vf__dispatch" value="Check_49" />
&nbsp;</td></tr>';

$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario 49 Quick Pick : ' . $sQuickPick1 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario 49 Quick Pick : ' . $sQuickPick2 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario 49 Quick Pick : ' . $sQuickPick3 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario 49 Quick Pick : ' . $sQuickPick4 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario 49 Quick Pick : ' . $sQuickPick5 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario 49 Quick Pick : ' . $sQuickPick6 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario 49 Quick Pick : ' . $sQuickPick7 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario 49 Quick Pick : ' . $sQuickPick8 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario 49 Quick Pick : ' . $sQuickPick9 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario 49 Quick Pick : ' . $sQuickPick10 . '</h3></td></tr>';
