...
$sQuickPick1  =  implode("-",$QuickPick->OLGKenoQuickPick(5));
$sQuickPick2  =  implode("-",$QuickPick->OLGKenoQuickPick(6)) ;
...
$sQuickPick6  =  implode("-",$QuickPick->OLGKenoQuickPick(7)) ;
$sQuickPick7  =  implode("-",$QuickPick->OLGKenoQuickPick(5)) ;
$sQuickPick8  =  implode("-",$QuickPick->OLGKenoQuickPick(6)) ;
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 5 : ' . $sQuickPick1  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 6 : ' .  $sQuickPick2 . '</h3></td></tr>';
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 7 : ' .  $sQuickPick6 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 5 : ' . $sQuickPick7 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 6 : ' . $sQuickPick8  . '</h3></td></tr>';
