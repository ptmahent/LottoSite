...
$sQuickPick1  =  implode("-",$QuickPick->OLGKenoQuickPick(4));
$sQuickPick2  =  implode("-",$QuickPick->OLGKenoQuickPick(5)) ;
$sQuickPick3  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick4  =  implode("-",$QuickPick->OLGKenoQuickPick(4)) ;
$sQuickPick5  =  implode("-",$QuickPick->OLGKenoQuickPick(5)) ;
$sQuickPick6  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick7  =  implode("-",$QuickPick->OLGKenoQuickPick(4)) ;
$sQuickPick8  =  implode("-",$QuickPick->OLGKenoQuickPick(5)) ;
$sQuickPick9  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick10 =  implode("-",$QuickPick->OLGKenoQuickPick(4)) ;
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 4 : ' . $sQuickPick1  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 5 : ' .  $sQuickPick2 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' . $sQuickPick3 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 4 : ' .  $sQuickPick4  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 5 : ' . $sQuickPick5 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' .  $sQuickPick6 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 4 : ' . $sQuickPick7 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 5 : ' . $sQuickPick8  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' . $sQuickPick9 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 4 : ' .  $sQuickPick10 . '</h3></td></tr>';
