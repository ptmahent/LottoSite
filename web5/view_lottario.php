...
. '<tr><td>Draw Date</td><td colspan="6">Winning Number</td><td>Bonus</td>'
. '<td colspan="4">Early Bird</td><td>&nbsp;</td></tr>';
...
. '<td>' . "Early Bird: " . $db_row["eb_snum1"] . '</td>'
. '<td>' . $db_row["eb_snum2"] . '</td>'
. '<td>' . $db_row["eb_snum3"] . '</td>'
. '<td>' . $db_row["eb_snum4"] . '</td>'
. '</tr>';
