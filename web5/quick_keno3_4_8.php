...
$sQuickPick6  =  implode("-",$QuickPick->OLGKenoQuickPick(8)) ;
$sQuickPick7  =  implode("-",$QuickPick->OLGKenoQuickPick(3)) ;
$sQuickPick8  =  implode("-",$QuickPick->OLGKenoQuickPick(4)) ;
$sQuickPick9  =  implode("-",$QuickPick->OLGKenoQuickPick(8)) ;
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 8 : ' .  $sQuickPick6 . '</h3></td></tr>';
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 8 : ' . $sQuickPick9 . '</h3></td></tr>';
