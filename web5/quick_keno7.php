...
$sQuickPick2  =  implode("-",$QuickPick->OLGKenoQuickPick(7)) ;
...
$sQuickPick8  =  implode("-",$QuickPick->OLGKenoQuickPick(7)) ;
$sQuickPick9  =  implode("-",$QuickPick->OLGKenoQuickPick(7)) ;
$sQuickPick10 =  implode("-",$QuickPick->OLGKenoQuickPick(7)) ;
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 7 : ' .  $sQuickPick2 . '</h3></td></tr>';
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 7 : ' . $sQuickPick8  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 7 : ' . $sQuickPick9 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 7 : ' .  $sQuickPick10 . '</h3></td></tr>';
