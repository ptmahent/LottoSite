...
$sQuickPick1  =  implode("-",$QuickPick->OLGKenoQuickPick(7));
$sQuickPick2  =  implode("-",$QuickPick->OLGKenoQuickPick(8)) ;
$sQuickPick3  =  implode("-",$QuickPick->OLGKenoQuickPick(7)) ;
$sQuickPick4  =  implode("-",$QuickPick->OLGKenoQuickPick(8)) ;
$sQuickPick5  =  implode("-",$QuickPick->OLGKenoQuickPick(7)) ;
$sQuickPick6  =  implode("-",$QuickPick->OLGKenoQuickPick(8)) ;
$sQuickPick7  =  implode("-",$QuickPick->OLGKenoQuickPick(7)) ;
$sQuickPick8  =  implode("-",$QuickPick->OLGKenoQuickPick(8)) ;
$sQuickPick9  =  implode("-",$QuickPick->OLGKenoQuickPick(7)) ;
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 7 : ' . $sQuickPick1  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 8 : ' .  $sQuickPick2 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 7 : ' . $sQuickPick3 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 8 : ' .  $sQuickPick4  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 7 : ' . $sQuickPick5 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 8 : ' .  $sQuickPick6 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 7 : ' . $sQuickPick7 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 8 : ' . $sQuickPick8  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 7 : ' . $sQuickPick9 . '</h3></td></tr>';
