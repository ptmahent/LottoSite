...
$htmlFormStartOut .= '<form name="Check_Keno" id="Check_Keno" method="post" enctype="multipart/form-data" action="check_lottario.php">';
...
$sQuickPick1  =  implode("-",$QuickPick->OLGLottarioQuickPick());
$sQuickPick2  =  implode("-",$QuickPick->OLGLottarioQuickPick()) ;
$sQuickPick3  =  implode("-",$QuickPick->OLGLottarioQuickPick()) ;
$sQuickPick4  =  implode("-",$QuickPick->OLGLottarioQuickPick()) ;
$sQuickPick5  =  implode("-",$QuickPick->OLGLottarioQuickPick()) ;
$sQuickPick6  =  implode("-",$QuickPick->OLGLottarioQuickPick()) ;
$sQuickPick7  =  implode("-",$QuickPick->OLGLottarioQuickPick()) ;
$sQuickPick8  =  implode("-",$QuickPick->OLGLottarioQuickPick()) ;
$sQuickPick9  =  implode("-",$QuickPick->OLGLottarioQuickPick()) ;
$sQuickPick10 =  implode("-",$QuickPick->OLGLottarioQuickPick()) ;
...
<input type="hidden" name="addLottarionums" value="on" />

<input type="hidden" name="OLG_Lottario" value="' . $sQuickPick1 . '" />
<input type="hidden" name="Early_Bird" value="1-2-3-4" />
<input type="hidden" name="Early_Bird_2" value="1-2-3-4" />
<input type="hidden" name="Early_Bird_3" value="1-2-3-4" />
<input type="hidden" name="Early_Bird_3" value="1-2-3-4" />
<input type="hidden" name="Early_Bird_4" value="1-2-3-4" />
<input type="hidden" name="Early_Bird_5" value="1-2-3-4" />
<input type="hidden" name="Early_Bird_6" value="1-2-3-4" />
<input type="hidden" name="Early_Bird_7" value="1-2-3-4" />
<input type="hidden" name="Early_Bird_8" value="1-2-3-4" />
<input type="hidden" name="Early_Bird_9" value="1-2-3-4" />
<input type="hidden" name="Early_Bird_10" value="1-2-3-4" />

<input type="hidden" name="OLG_Lottario_2" value="' . $sQuickPick2 . '" />
<input type="hidden" name="OLG_Lottario_3" value="' . $sQuickPick3 . '" />
<input type="hidden" name="OLG_Lottario_4" value="' . $sQuickPick4 . '" />
<input type="hidden" name="OLG_Lottario_5" value="' . $sQuickPick5 . '" />
<input type="hidden" name="OLG_Lottario_6" value="' . $sQuickPick6 . '" />
<input type="hidden" name="OLG_Lottario_7" value="' . $sQuickPick7 . '" />
<input type="hidden" name="OLG_Lottario_8" value="' . $sQuickPick8 . '" />
<input type="hidden" name="OLG_Lottario_9" value="' . $sQuickPick9 . '" />
<input type="hidden" name="OLG_Lottario_10" value="' . $sQuickPick10 . '" />
<input type="hidden" name="vf__dispatch" value="Check_Lottario" />
&nbsp;</td></tr>
';



$htmlMainCont .= '<tr><td id="quickCell"><h3>Lottario Quick Pick : ' . $sQuickPick1 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lottario  Quick Pick : ' . $sQuickPick2 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lottario Quick Pick : ' . $sQuickPick3 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lottario Quick Pick : ' . $sQuickPick4 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lottario Quick Pick : ' . $sQuickPick5 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lottario Quick Pick : ' . $sQuickPick6 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lottario Quick Pick : ' . $sQuickPick7 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lottario Quick Pick : ' . $sQuickPick8 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lottario Quick Pick : ' . $sQuickPick9 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lottario Quick Pick : ' . $sQuickPick10 . '</h3></td></tr>';
