...
$smarty->assign('GAME', 'OLGPICK3');
$smarty->assign('htmltopOut', $htmltopOut);

$htmlFormStartOut = "";

$htmlFormStartOut .= '<form name="Check_Keno" id="Check_Keno" method="post" enctype="multipart/form-data" action="check_pick3.php">';
...
$sQuickPick1  =  implode("-",$QuickPick->OLGPick3QuickPick());
$sQuickPick2  =  implode("-",$QuickPick->OLGPick3QuickPick()) ;
$sQuickPick3  =  implode("-",$QuickPick->OLGPick3QuickPick()) ;
$sQuickPick4  =  implode("-",$QuickPick->OLGPick3QuickPick()) ;
$sQuickPick5  =  implode("-",$QuickPick->OLGPick3QuickPick()) ;
$sQuickPick6  =  implode("-",$QuickPick->OLGPick3QuickPick()) ;
$sQuickPick7  =  implode("-",$QuickPick->OLGPick3QuickPick()) ;
$sQuickPick8  =  implode("-",$QuickPick->OLGPick3QuickPick()) ;
$sQuickPick9  =  implode("-",$QuickPick->OLGPick3QuickPick()) ;
$sQuickPick10 =  implode("-",$QuickPick->OLGPick3QuickPick()) ;
...
<input type="hidden" name="addPick3Nums" value="on" />
<input type="hidden" name="OLG_Pick3" value="' . $sQuickPick1 . '" />
<input type="hidden" name="OLG_Pick3_2" value="' . $sQuickPick2 . '" />
<input type="hidden" name="OLG_Pick3_3" value="' . $sQuickPick3 . '" />
<input type="hidden" name="OLG_Pick3_4" value="' . $sQuickPick4 . '" />
<input type="hidden" name="OLG_Pick3_5" value="' . $sQuickPick5 . '" />
<input type="hidden" name="OLG_Pick3_6" value="' . $sQuickPick6 . '" />
<input type="hidden" name="OLG_Pick3_7" value="' . $sQuickPick7 . '" />
<input type="hidden" name="OLG_Pick3_8" value="' . $sQuickPick8 . '" />
<input type="hidden" name="OLG_Pick3_9" value="' . $sQuickPick9 . '" />
<input type="hidden" name="OLG_Pick3_10" value="' . $sQuickPick10 . '" />
<input type="hidden" name="vf__dispatch" value="Check_Pick3" />
&nbsp;</td></tr>
';



$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 3 Quick Pick : ' . $sQuickPick1 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 3 Quick Pick : ' . $sQuickPick2 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 3 Quick Pick : ' . $sQuickPick3 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 3 Quick Pick : ' . $sQuickPick4 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 3 Quick Pick : ' . $sQuickPick5 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 3 Quick Pick : ' . $sQuickPick6 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 3 Quick Pick : ' . $sQuickPick7 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 3 Quick Pick : ' . $sQuickPick8 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 3 Quick Pick : ' . $sQuickPick9 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 3 Quick Pick : ' . $sQuickPick10 . '</h3></td></tr>';
