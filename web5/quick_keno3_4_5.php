...
$sQuickPick3  =  implode("-",$QuickPick->OLGKenoQuickPick(5)) ;
...
$sQuickPick9  =  implode("-",$QuickPick->OLGKenoQuickPick(5)) ;
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 5 : ' . $sQuickPick3 . '</h3></td></tr>';
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 5 : ' . $sQuickPick9 . '</h3></td></tr>';
