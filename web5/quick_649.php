...
$htmlFormStartOut .= '<form name="Check_Keno" id="Check_Keno" method="post" enctype="multipart/form-data" action="check_649.php">';
...
$sQuickPick1  =  implode("-",$QuickPick->na649QuickPick());
$sQuickPick2  =  implode("-",$QuickPick->na649QuickPick()) ;
$sQuickPick3  =  implode("-",$QuickPick->na649QuickPick()) ;
$sQuickPick4  =  implode("-",$QuickPick->na649QuickPick()) ;
$sQuickPick5  =  implode("-",$QuickPick->na649QuickPick()) ;
$sQuickPick6  =  implode("-",$QuickPick->na649QuickPick()) ;
$sQuickPick7  =  implode("-",$QuickPick->na649QuickPick()) ;
$sQuickPick8  =  implode("-",$QuickPick->na649QuickPick()) ;
$sQuickPick9  =  implode("-",$QuickPick->na649QuickPick()) ;
$sQuickPick10 =  implode("-",$QuickPick->na649QuickPick()) ;
...
<input type="hidden" name="add649nums" value="on" />

<input type="hidden" name="NA_649" value="' . $sQuickPick1 . '" />
<input type="hidden" name="NA_649_2" value="' . $sQuickPick2 . '" />
<input type="hidden" name="NA_649_3" value="' . $sQuickPick3 . '" />
<input type="hidden" name="NA_649_4" value="' . $sQuickPick4 . '" />
<input type="hidden" name="NA_649_5" value="' . $sQuickPick5 . '" />
<input type="hidden" name="NA_649_6" value="' . $sQuickPick6 . '" />
<input type="hidden" name="NA_649_7" value="' . $sQuickPick7 . '" />
<input type="hidden" name="NA_649_8" value="' . $sQuickPick8 . '" />
<input type="hidden" name="NA_649_9" value="' . $sQuickPick9 . '" />
<input type="hidden" name="NA_649_10" value="' . $sQuickPick10 . '" />
<input type="hidden" name="vf__dispatch" value="Check_649" />
&nbsp;</td></tr>
';



$htmlMainCont .= '<tr><td id="quickCell"><h3>Lotto 649 Quick Pick : ' . $sQuickPick1 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lotto 649 Quick Pick : ' . $sQuickPick2 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lotto 649 Quick Pick : ' . $sQuickPick3 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lotto 649 Quick Pick : ' . $sQuickPick4 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lotto 649 Quick Pick : ' . $sQuickPick5 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lotto 649 Quick Pick : ' . $sQuickPick6 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lotto 649 Quick Pick : ' . $sQuickPick7 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lotto 649 Quick Pick : ' . $sQuickPick8 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lotto 649 Quick Pick : ' . $sQuickPick9 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Lotto 649 Quick Pick : ' . $sQuickPick10 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell">To see winning history for selected numbers above <input type="Submit" value="Submit" /></td></tr>';
