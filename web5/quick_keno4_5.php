...
$sQuickPick3  =  implode("-",$QuickPick->OLGKenoQuickPick(4)) ;
$sQuickPick4  =  implode("-",$QuickPick->OLGKenoQuickPick(5)) ;
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 14 : ' . $sQuickPick1  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 5 : ' .  $sQuickPick2 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 4 : ' . $sQuickPick3 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 5 : ' .  $sQuickPick4  . '</h3></td></tr>';
