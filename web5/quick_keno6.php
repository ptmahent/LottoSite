...
$sQuickPick1  =  implode("-",$QuickPick->OLGKenoQuickPick(6));
$sQuickPick2  =  implode("-",$QuickPick->OLGKenoQuickPick(6)) ;
$sQuickPick3  =  implode("-",$QuickPick->OLGKenoQuickPick(6)) ;
$sQuickPick4  =  implode("-",$QuickPick->OLGKenoQuickPick(6)) ;
$sQuickPick5  =  implode("-",$QuickPick->OLGKenoQuickPick(6)) ;
$sQuickPick6  =  implode("-",$QuickPick->OLGKenoQuickPick(6)) ;
$sQuickPick7  =  implode("-",$QuickPick->OLGKenoQuickPick(6)) ;
$sQuickPick8  =  implode("-",$QuickPick->OLGKenoQuickPick(6)) ;
$sQuickPick9  =  implode("-",$QuickPick->OLGKenoQuickPick(6)) ;
$sQuickPick10 =  implode("-",$QuickPick->OLGKenoQuickPick(6)) ;
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 6 : ' . $sQuickPick1  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 6 : ' .  $sQuickPick2 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 6 : ' . $sQuickPick3 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 6 : ' .  $sQuickPick4  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 6 : ' . $sQuickPick5 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 6 : ' .  $sQuickPick6 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 6 : ' . $sQuickPick7 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 6 : ' . $sQuickPick8  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 6 : ' . $sQuickPick9 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 6 : ' .  $sQuickPick10 . '</h3></td></tr>';
