...
$smarty->assign('GAME', 'OLGPICK4');
$smarty->assign('htmltopOut', $htmltopOut);

$htmlFormStartOut = "";

$htmlFormStartOut .= '<form name="Check_Keno" id="Check_Keno" method="post" enctype="multipart/form-data" action="check_pick4.php">';
...
$sQuickPick1  =  implode("-",$QuickPick->OLGPick4QuickPick());
$sQuickPick2  =  implode("-",$QuickPick->OLGPick4QuickPick()) ;
$sQuickPick3  =  implode("-",$QuickPick->OLGPick4QuickPick()) ;
$sQuickPick4  =  implode("-",$QuickPick->OLGPick4QuickPick()) ;
$sQuickPick5  =  implode("-",$QuickPick->OLGPick4QuickPick()) ;
$sQuickPick6  =  implode("-",$QuickPick->OLGPick4QuickPick()) ;
$sQuickPick7  =  implode("-",$QuickPick->OLGPick4QuickPick()) ;
$sQuickPick8  =  implode("-",$QuickPick->OLGPick4QuickPick()) ;
$sQuickPick9  =  implode("-",$QuickPick->OLGPick4QuickPick()) ;
$sQuickPick10 =  implode("-",$QuickPick->OLGPick4QuickPick()) ;
...
<input type="hidden" name="addPick4Nums" value="on" />
<input type="hidden" name="OLG_Pick4" value="' . $sQuickPick1 . '" />
<input type="hidden" name="OLG_Pick4_2" value="' . $sQuickPick2 . '" />
<input type="hidden" name="OLG_Pick4_3" value="' . $sQuickPick3 . '" />
<input type="hidden" name="OLG_Pick4_4" value="' . $sQuickPick4 . '" />
<input type="hidden" name="OLG_Pick4_5" value="' . $sQuickPick5 . '" />
<input type="hidden" name="OLG_Pick4_6" value="' . $sQuickPick6 . '" />
<input type="hidden" name="OLG_Pick4_7" value="' . $sQuickPick7 . '" />
<input type="hidden" name="OLG_Pick4_8" value="' . $sQuickPick8 . '" />
<input type="hidden" name="OLG_Pick4_9" value="' . $sQuickPick9 . '" />
<input type="hidden" name="OLG_Pick4_10" value="' . $sQuickPick10 . '" />
<input type="hidden" name="vf__dispatch" value="Check_Pick4" />
&nbsp;</td></tr>
...
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 4 Quick Pick : ' . $sQuickPick1 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 4 Quick Pick : ' . $sQuickPick2 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 4 Quick Pick : ' . $sQuickPick3 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 4 Quick Pick : ' . $sQuickPick4 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 4 Quick Pick : ' . $sQuickPick5 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 4 Quick Pick : ' . $sQuickPick6 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 4 Quick Pick : ' . $sQuickPick7 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 4 Quick Pick : ' . $sQuickPick8 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 4 Quick Pick : ' . $sQuickPick9 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td id="quickCell"><h3>Ontario Pick 4 Quick Pick : ' . $sQuickPick10 . '</h3></td></tr>';
