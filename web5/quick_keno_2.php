...
$sQuickPick1  =  implode("-",$QuickPick->OLGKenoQuickPick(2));
$sQuickPick2  =  implode("-",$QuickPick->OLGKenoQuickPick(2)) ;
$sQuickPick3  =  implode("-",$QuickPick->OLGKenoQuickPick(2)) ;
$sQuickPick4  =  implode("-",$QuickPick->OLGKenoQuickPick(2)) ;
$sQuickPick5  =  implode("-",$QuickPick->OLGKenoQuickPick(2)) ;
$sQuickPick6  =  implode("-",$QuickPick->OLGKenoQuickPick(2)) ;
$sQuickPick7  =  implode("-",$QuickPick->OLGKenoQuickPick(2)) ;
$sQuickPick8  =  implode("-",$QuickPick->OLGKenoQuickPick(2)) ;
$sQuickPick9  =  implode("-",$QuickPick->OLGKenoQuickPick(2)) ;
$sQuickPick10 =  implode("-",$QuickPick->OLGKenoQuickPick(2)) ;
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 2 : ' . $sQuickPick1  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 2 : ' .  $sQuickPick2 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 2 : ' . $sQuickPick3 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 2 : ' .  $sQuickPick4  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 2 : ' . $sQuickPick5 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 2 : ' .  $sQuickPick6 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 2 : ' . $sQuickPick7 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 2 : ' . $sQuickPick8  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 2 : ' . $sQuickPick9 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 2 : ' .  $sQuickPick10 . '</h3></td></tr>';
