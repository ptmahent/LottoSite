...
$sQuickPick2  =  implode("-",$QuickPick->OLGKenoQuickPick(3)) ;
$sQuickPick3  =  implode("-",$QuickPick->OLGKenoQuickPick(3)) ;
$sQuickPick4  =  implode("-",$QuickPick->OLGKenoQuickPick(3)) ;
$sQuickPick5  =  implode("-",$QuickPick->OLGKenoQuickPick(3)) ;
$sQuickPick6  =  implode("-",$QuickPick->OLGKenoQuickPick(3)) ;
$sQuickPick7  =  implode("-",$QuickPick->OLGKenoQuickPick(3)) ;
$sQuickPick8  =  implode("-",$QuickPick->OLGKenoQuickPick(3)) ;
$sQuickPick9  =  implode("-",$QuickPick->OLGKenoQuickPick(3)) ;
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 3 : ' .  $sQuickPick2 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 3 : ' . $sQuickPick3 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 3 : ' .  $sQuickPick4  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 3 : ' . $sQuickPick5 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 3 : ' .  $sQuickPick6 . '</h3></td></tr>';
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 3 : ' . $sQuickPick9 . '</h3></td></tr>';
