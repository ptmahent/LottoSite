...
session_start();
  ...
  $objForm = new ValidForm("Check_Max", "Required fields are printed in bold.");
  ...
  foreach ($lotto_validat_res as $lotto_single_game) {
      ...
      foreach ($lotto_single_game["validation_res"] as $s_single_match) {
        ...
        $b_win_num_match = false;
          ...
          if ($b_win_num_match) {
            $htmlOut .= "<td id='matchNumber'>" . $lotto_single_game["played_nums"][6] . "</td>";
          } elseif ($b_bonus_num_match) {
            $htmlOut .= "<td id='matchBonusNumber'>" . $lotto_single_game["played_nums"][6] . "</td>";
             
          } else {
            $htmlOut .= "<td id='notMatchNumber'>" . $lotto_single_game["played_nums"][6] . "</td>";
          }
    ...
    $htmlOut .= "<td id='drawNumber'>" . $s_single_match["draw_numbers"][0] . "</td><td id='drawNumber'>" . $s_single_match["draw_numbers"][1] . " </td><td id='drawNumber'> " . $s_single_match["draw_numbers"][2] . " </td><td id='drawNumber'> " . $s_single_match["draw_numbers"][3] . " </td><td id='drawNumber'>" . $s_single_match["draw_numbers"][4] . "</td><td id='drawNumber'> " . $s_single_match["draw_numbers"][5] . " </td><td id='drawNumber'> " . $s_single_match["draw_numbers"][6] . " </td><td id='matchBonusNumber'> " . $s_single_match["draw_bonus"] . "</td></tr>";
      } 
    }
    $icur_game_cnt++;
