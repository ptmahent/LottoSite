...
$sQuickPick1  =  implode("-",$QuickPick->OLGKenoQuickPick(9));
$sQuickPick2  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick3  =  implode("-",$QuickPick->OLGKenoQuickPick(9)) ;
$sQuickPick4  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick5  =  implode("-",$QuickPick->OLGKenoQuickPick(9)) ;
$sQuickPick6  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick7  =  implode("-",$QuickPick->OLGKenoQuickPick(9)) ;
$sQuickPick8  =  implode("-",$QuickPick->OLGKenoQuickPick(10)) ;
$sQuickPick9  =  implode("-",$QuickPick->OLGKenoQuickPick(9)) ;
...
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 9 : ' . $sQuickPick1  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' .  $sQuickPick2 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 9 : ' . $sQuickPick3 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' .  $sQuickPick4  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 9 : ' . $sQuickPick5 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' .  $sQuickPick6 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 9 : ' . $sQuickPick7 . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 10 : ' . $sQuickPick8  . '</h3></td></tr>';
$htmlMainCont .= '<tr><td  id="quickCell"><h3>Keno Quick Pick - 9 : ' . $sQuickPick9 . '</h3></td></tr>';
