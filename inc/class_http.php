...
class http {
    ...
    */
    function clean()
    {
        ...
        */
        if ($_SERVER && array_key_exists("HTTP_USER_AGENT", $_SERVER) && isset($_SERVER['HTTP_USER_AGENT'])) {
        ...
        page.
        */
        if ($_SERVER && array_key_exists("SERVER_PROTOCOL", $_SERVER) && (substr($_SERVER['SERVER_PROTOCOL'],0,5) == "HTTPS")) {
            $this->headers["Referer"] = "https://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];
        } else if ($_SERVER && array_key_exists("SERVER_PROTOCOL", $_SERVER) && (substr($_SERVER['SERVER_PROTOCOL'],0,5) == "HTTP")) {
